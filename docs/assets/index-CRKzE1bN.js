...
`});const p={type:"element",tagName:"li",properties:u,children:c};return t.patch(i,p),t.applyData(i,p)}function E3(t){let i=!1;if(t.type==="list"){i=t.spread||!1;const a=t.children;let r=-1;for(;!i&&++r<a.length;)i=B0(a[r])}return i}function B0(t){const i=t.spread;return i??t.children.length>1}function C3(t,i){const a={},r=t.all(i);let s=-1;for(typeof i.start=="number"&&i.start!==1&&(a.start=i.start);++s<r.length;){const c=r[s];if(c.type==="element"&&c.tagName==="li"&&c.properties&&Array.isArray(c.properties.className)&&c.properties.className.includes("task-list-item")){a.className=["contains-task-list"];break}}const u={type:"element",tagName:i.ordered?"ol":"ul",properties:a,children:t.wrap(r,!0)};return t.patch(i,u),t.applyData(i,u)}function T3(t,i){const a={type:"element",tagName:"p",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}function N3(t,i){const a={type:"root",children:t.wrap(t.all(i))};return t.patch(i,a),t.applyData(i,a)}function _3(t,i){const a={type:"element",tagName:"strong",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}function z3(t,i){const a=t.all(i),r=a.shift(),s=[];if(r){const c={type:"element",tagName:"thead",properties:{},children:t.wrap([r],!0)};t.patch(i.children[0],c),s.push(c)}if(a.length>0){const c={type:"element",tagName:"tbody",properties:{},children:t.wrap(a,!0)},h=Nf(i.children[1]),m=g0(i.children[i.children.length-1]);h&&m&&(c.position={start:h,end:m}),s.push(c)}const u={type:"element",tagName:"table",properties:{},children:t.wrap(s,!0)};return t.patch(i,u),t.applyData(i,u)}function R3(t,i,a){const r=a?a.children:void 0,u=(r?r.indexOf(i):1)===0?"th":"td",c=a&&a.type==="table"?a.align:void 0,h=c?c.length:i.children.length;let m=-1;const p=[];for(;++m<h;){const g=i.children[m],b={},S=c?c[m]:void 0;S&&(b.align=S);let E={type:"element",tagName:u,properties:b,children:[]};g&&(E.children=t.all(g),t.patch(g,E),E=t.applyData(g,E)),p.push(E)}const y={type:"element",tagName:"tr",properties:{},children:t.wrap(p,!0)};return t.patch(i,y),t.applyData(i,y)}function M3(t,i){const a={type:"element",tagName:"td",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}const Ig=9,Vg=32;function j3(t){const i=String(t),a=/\r?\n|\r/g;let r=a.exec(i),s=0;const u=[];for(;r;)u.push(Gg(i.slice(s,r.index),s>0,!0),r[0]),s=r.index+r[0].length,r=a.exec(i);return u.push(Gg(i.slice(s),s>0,!1)),u.join("")}function Gg(t,i,a){let r=0,s=t.length;if(i){let u=t.codePointAt(r);for(;u===Ig||u===Vg;)r++,u=t.codePointAt(r)}if(a){let u=t.codePointAt(s-1);for(;u===Ig||u===Vg;)s--,u=t.codePointAt(s-1)}return s>r?t.slice(r,s):""}function D3(t,i){const a={type:"text",value:j3(String(i.value))};return t.patch(i,a),t.applyData(i,a)}function O3(t,i){const a={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(i,a),t.applyData(i,a)}const L3={blockquote:f3,break:d3,code:h3,delete:p3,emphasis:m3,footnoteReference:g3,heading:y3,html:x3,imageReference:b3,image:v3,inlineCode:S3,linkReference:w3,link:A3,listItem:k3,list:C3,paragraph:T3,root:N3,strong:_3,table:z3,tableCell:M3,tableRow:R3,text:D3,thematicBreak:O3,toml:Lo,yaml:Lo,definition:Lo,footnoteDefinition:Lo};function Lo(){}const H0=-1,as=0,lr=1,Zo=2,Of=3,Lf=4,Bf=5,Hf=6,U0=7,q0=8,Yg=typeof self=="object"?self:globalThis,B3=(t,i)=>{const a=(s,u)=>(t.set(u,s),s),r=s=>{if(t.has(s))return t.get(s);const[u,c]=i[s];switch(u){case as:case H0:return a(c,s);case lr:{const h=a([],s);for(const m of c)h.push(r(m));return h}case Zo:{const h=a({},s);for(const[m,p]of c)h[r(m)]=r(p);return h}case Of:return a(new Date(c),s);case Lf:{const{source:h,flags:m}=c;return a(new RegExp(h,m),s)}case Bf:{const h=a(new Map,s);for(const[m,p]of c)h.set(r(m),r(p));return h}case Hf:{const h=a(new Set,s);for(const m of c)h.add(r(m));return h}case U0:{const{name:h,message:m}=c;return a(new Yg[h](m),s)}case q0:return a(BigInt(c),s);case"BigInt":return a(Object(BigInt(c)),s);case"ArrayBuffer":return a(new Uint8Array(c).buffer,c);case"DataView":{const{buffer:h}=new Uint8Array(c);return a(new DataView(h),c)}}return a(new Yg[u](c),s)};return r},Xg=t=>B3(new Map,t)(0),Ga="",{toString:H3}={},{keys:U3}=Object,Wi=t=>{const i=typeof t;if(i!=="object"||!t)return[as,i];const a=H3.call(t).slice(8,-1);switch(a){case"Array":return[lr,Ga];case"Object":return[Zo,Ga];case"Date":return[Of,Ga];case"RegExp":return[Lf,Ga];case"Map":return[Bf,Ga];case"Set":return[Hf,Ga];case"DataView":return[lr,a]}return a.includes("Array")?[lr,a]:a.includes("Error")?[U0,a]:[Zo,a]},Bo=([t,i])=>t===as&&(i==="function"||i==="symbol"),q3=(t,i,a,r)=>{const s=(c,h)=>{const m=r.push(c)-1;return a.set(h,m),m},u=c=>{if(a.has(c))return a.get(c);let[h,m]=Wi(c);switch(h){case as:{let y=c;switch(m){case"bigint":h=q0,y=c.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+m);y=null;break;case"undefined":return s([H0],c)}return s([h,y],c)}case lr:{if(m){let b=c;return m==="DataView"?b=new Uint8Array(c.buffer):m==="ArrayBuffer"&&(b=new Uint8Array(c)),s([m,[...b]],c)}const y=[],g=s([h,y],c);for(const b of c)y.push(u(b));return g}case Zo:{if(m)switch(m){case"BigInt":return s([m,c.toString()],c);case"Boolean":case"Number":case"String":return s([m,c.valueOf()],c)}if(i&&"toJSON"in c)return u(c.toJSON());const y=[],g=s([h,y],c);for(const b of U3(c))(t||!Bo(Wi(c[b])))&&y.push([u(b),u(c[b])]);return g}case Of:return s([h,c.toISOString()],c);case Lf:{const{source:y,flags:g}=c;return s([h,{source:y,flags:g}],c)}case Bf:{const y=[],g=s([h,y],c);for(const[b,S]of c)(t||!(Bo(Wi(b))||Bo(Wi(S))))&&y.push([u(b),u(S)]);return g}case Hf:{const y=[],g=s([h,y],c);for(const b of c)(t||!Bo(Wi(b)))&&y.push(u(b));return g}}const{message:p}=c;return s([h,{name:m,message:p}],c)};return u},Qg=(t,{json:i,lossy:a}={})=>{const r=[];return q3(!(i||a),!!i,new Map,r)(t),r},Ko=typeof structuredClone=="function"?(t,i)=>i&&("json"in i||"lossy"in i)?Xg(Qg(t,i)):structuredClone(t):(t,i)=>Xg(Qg(t,i));function I3(t,i){const a=[{type:"text",value:"↩"}];return i>1&&a.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(i)}]}),a}function V3(t,i){return"Back to reference "+(t+1)+(i>1?"-"+i:"")}function G3(t){const i=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",a=t.options.footnoteBackContent||I3,r=t.options.footnoteBackLabel||V3,s=t.options.footnoteLabel||"Footnotes",u=t.options.footnoteLabelTagName||"h2",c=t.options.footnoteLabelProperties||{className:["sr-only"]},h=[];let m=-1;for(;++m<t.footnoteOrder.length;){const p=t.footnoteById.get(t.footnoteOrder[m]);if(!p)continue;const y=t.all(p),g=String(p.identifier).toUpperCase(),b=Ja(g.toLowerCase());let S=0;const E=[],z=t.footnoteCounts.get(g);for(;z!==void 0&&++S<=z;){E.length>0&&E.push({type:"text",value:" "});let j=typeof a=="string"?a:a(m,S);typeof j=="string"&&(j={type:"text",value:j}),E.push({type:"element",tagName:"a",properties:{href:"#"+i+"fnref-"+b+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof r=="string"?r:r(m,S),className:["data-footnote-backref"]},children:Array.isArray(j)?j:[j]})}const T=y[y.length-1];if(T&&T.type==="element"&&T.tagName==="p"){const j=T.children[T.children.length-1];j&&j.type==="text"?j.value+=" ":T.children.push({type:"text",value:" "}),T.children.push(...E)}else y.push(...E);const N={type:"element",tagName:"li",properties:{id:i+"fn-"+b},children:t.wrap(y,!0)};t.patch(p,N),h.push(N)}if(h.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:u,properties:{...Ko(c),id:"footnote-label"},children:[{type:"text",value:s}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(h,!0)},{type:"text",value:`
`}]}}const is=(function(t){if(t==null)return F3;if(typeof t=="function")return rs(t);if(typeof t=="object")return Array.isArray(t)?Y3(t):X3(t);if(typeof t=="string")return Q3(t);throw new Error("Expected function, string, or object as test")});function Y3(t){const i=[];let a=-1;for(;++a<t.length;)i[a]=is(t[a]);return rs(r);function r(...s){let u=-1;for(;++u<i.length;)if(i[u].apply(this,s))return!0;return!1}}function X3(t){const i=t;return rs(a);function a(r){const s=r;let u;for(u in t)if(s[u]!==i[u])return!1;return!0}}function Q3(t){return rs(i);function i(a){return a&&a.type===t}}function rs(t){return i;function i(a,r,s){return!!(Z3(a)&&t.call(this,a,typeof r=="number"?r:void 0,s||void 0))}}function F3(){return!0}function Z3(t){return t!==null&&typeof t=="object"&&"type"in t}const I0=[],K3=!0,rf=!1,$3="skip";function V0(t,i,a,r){let s;typeof i=="function"&&typeof a!="function"?(r=a,a=i):s=i;const u=is(s),c=r?-1:1;h(t,void 0,[])();function h(m,p,y){const g=m&&typeof m=="object"?m:{};if(typeof g.type=="string"){const S=typeof g.tagName=="string"?g.tagName:typeof g.name=="string"?g.name:void 0;Object.defineProperty(b,"name",{value:"node ("+(m.type+(S?"<"+S+">":""))+")"})}return b;function b(){let S=I0,E,z,T;if((!i||u(m,p,y[y.length-1]||void 0))&&(S=P3(a(m,y)),S[0]===rf))return S;if("children"in m&&m.children){const N=m;if(N.children&&S[0]!==$3)for(z=(r?N.children.length:-1)+c,T=y.concat(N);z>-1&&z<N.children.length;){const j=N.children[z];if(E=h(j,z,T)(),E[0]===rf)return E;z=typeof E[1]=="number"?E[1]:z+c}}return S}}}function P3(t){return Array.isArray(t)?t:typeof t=="number"?[K3,t]:t==null?I0:[t]}function Uf(t,i,a,r){let s,u,c;typeof i=="function"&&typeof a!="function"?(u=void 0,c=i,s=a):(u=i,c=a,s=r),V0(t,u,h,s);function h(m,p){const y=p[p.length-1],g=y?y.children.indexOf(m):void 0;return c(m,g,y)}}const of={}.hasOwnProperty,J3={};function W3(t,i){const a=i||J3,r=new Map,s=new Map,u=new Map,c={...L3,...a.handlers},h={all:p,applyData:e4,definitionById:r,footnoteById:s,footnoteCounts:u,footnoteOrder:[],handlers:c,one:m,options:a,patch:n4,wrap:l4};return Uf(t,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const g=y.type==="definition"?r:s,b=String(y.identifier).toUpperCase();g.has(b)||g.set(b,y)}}),h;function m(y,g){const b=y.type,S=h.handlers[b];if(of.call(h.handlers,b)&&S)return S(h,y,g);if(h.options.passThrough&&h.options.passThrough.includes(b)){if("children"in y){const{children:z,...T}=y,N=Ko(T);return N.children=h.all(y),N}return Ko(y)}return(h.options.unknownHandler||t4)(h,y,g)}function p(y){const g=[];if("children"in y){const b=y.children;let S=-1;for(;++S<b.length;){const E=h.one(b[S],y);if(E){if(S&&b[S-1].type==="break"&&(!Array.isArray(E)&&E.type==="text"&&(E.value=Fg(E.value)),!Array.isArray(E)&&E.type==="element")){const z=E.children[0];z&&z.type==="text"&&(z.value=Fg(z.value))}Array.isArray(E)?g.push(...E):g.push(E)}}}return g}}function n4(t,i){t.position&&(i.position=VA(t))}function e4(t,i){let a=i;if(t&&t.data){const r=t.data.hName,s=t.data.hChildren,u=t.data.hProperties;if(typeof r=="string")if(a.type==="element")a.tagName=r;else{const c="children"in a?a.children:[a];a={type:"element",tagName:r,properties:{},children:c}}a.type==="element"&&u&&Object.assign(a.properties,Ko(u)),"children"in a&&a.children&&s!==null&&s!==void 0&&(a.children=s)}return a}function t4(t,i){const a=i.data||{},r="value"in i&&!(of.call(a,"hProperties")||of.call(a,"hChildren"))?{type:"text",value:i.value}:{type:"element",tagName:"div",properties:{},children:t.all(i)};return t.patch(i,r),t.applyData(i,r)}function l4(t,i){const a=[];let r=-1;for(i&&a.push({type:"text",value:`
`});++r<t.length;)r&&a.push({type:"text",value:`
`}),a.push(t[r]);return i&&t.length>0&&a.push({type:"text",value:`
`}),a}function Fg(t){let i=0,a=t.charCodeAt(i);for(;a===9||a===32;)i++,a=t.charCodeAt(i);return t.slice(i)}function Zg(t,i){const a=W3(t,i),r=a.one(t,void 0),s=G3(a),u=Array.isArray(r)?{type:"root",children:r}:r||{type:"root",children:[]};return s&&u.children.push({type:"text",value:`
`},s),u}function a4(t,i){return t&&"run"in t?async function(a,r){const s=Zg(a,{file:r,...i});await t.run(s,r)}:function(a,r){return Zg(a,{file:r,...t||i})}}function Kg(t){if(t)throw t}var Hc,$g;function i4(){if($g)return Hc;$g=1;var t=Object.prototype.hasOwnProperty,i=Object.prototype.toString,a=Object.defineProperty,r=Object.getOwnPropertyDescriptor,s=function(p){return typeof Array.isArray=="function"?Array.isArray(p):i.call(p)==="[object Array]"},u=function(p){if(!p||i.call(p)!=="[object Object]")return!1;var y=t.call(p,"constructor"),g=p.constructor&&p.constructor.prototype&&t.call(p.constructor.prototype,"isPrototypeOf");if(p.constructor&&!y&&!g)return!1;var b;for(b in p);return typeof b>"u"||t.call(p,b)},c=function(p,y){a&&y.name==="__proto__"?a(p,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):p[y.name]=y.newValue},h=function(p,y){if(y==="__proto__")if(t.call(p,y)){if(r)return r(p,y).value}else return;return p[y]};return Hc=function m(){var p,y,g,b,S,E,z=arguments[0],T=1,N=arguments.length,j=!1;for(typeof z=="boolean"&&(j=z,z=arguments[1]||{},T=2),(z==null||typeof z!="object"&&typeof z!="function")&&(z={});T<N;++T)if(p=arguments[T],p!=null)for(y in p)g=h(z,y),b=h(p,y),z!==b&&(j&&b&&(u(b)||(S=s(b)))?(S?(S=!1,E=g&&s(g)?g:[]):E=g&&u(g)?g:{},c(z,{name:y,newValue:m(j,E,b)})):typeof b<"u"&&c(z,{name:y,newValue:b}));return z},Hc}var r4=i4();const Uc=pf(r4);function sf(t){if(typeof t!="object"||t===null)return!1;const i=Object.getPrototypeOf(t);return(i===null||i===Object.prototype||Object.getPrototypeOf(i)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function o4(){const t=[],i={run:a,use:r};return i;function a(...s){let u=-1;const c=s.pop();if(typeof c!="function")throw new TypeError("Expected function as last argument, not "+c);h(null,...s);function h(m,...p){const y=t[++u];let g=-1;if(m){c(m);return}for(;++g<s.length;)(p[g]===null||p[g]===void 0)&&(p[g]=s[g]);s=p,y?s4(y,h)(...p):c(null,...p)}}function r(s){if(typeof s!="function")throw new TypeError("Expected `middelware` to be a function, not "+s);return t.push(s),i}}function s4(t,i){let a;return r;function r(...c){const h=t.length>c.length;let m;h&&c.push(s);try{m=t.apply(this,c)}catch(p){const y=p;if(h&&a)throw y;return s(y)}h||(m&&m.then&&typeof m.then=="function"?m.then(u,s):m instanceof Error?s(m):u(m))}function s(c,...h){a||(a=!0,i(c,...h))}function u(c){s(null,c)}}const St={basename:u4,dirname:c4,extname:f4,join:d4,sep:"/"};function u4(t,i){if(i!==void 0&&typeof i!="string")throw new TypeError('"ext" argument must be a string');dr(t);let a=0,r=-1,s=t.length,u;if(i===void 0||i.length===0||i.length>t.length){for(;s--;)if(t.codePointAt(s)===47){if(u){a=s+1;break}}else r<0&&(u=!0,r=s+1);return r<0?"":t.slice(a,r)}if(i===t)return"";let c=-1,h=i.length-1;for(;s--;)if(t.codePointAt(s)===47){if(u){a=s+1;break}}else c<0&&(u=!0,c=s+1),h>-1&&(t.codePointAt(s)===i.codePointAt(h--)?h<0&&(r=s):(h=-1,r=c));return a===r?r=c:r<0&&(r=t.length),t.slice(a,r)}function c4(t){if(dr(t),t.length===0)return".";let i=-1,a=t.length,r;for(;--a;)if(t.codePointAt(a)===47){if(r){i=a;break}}else r||(r=!0);return i<0?t.codePointAt(0)===47?"/":".":i===1&&t.codePointAt(0)===47?"//":t.slice(0,i)}function f4(t){dr(t);let i=t.length,a=-1,r=0,s=-1,u=0,c;for(;i--;){const h=t.codePointAt(i);if(h===47){if(c){r=i+1;break}continue}a<0&&(c=!0,a=i+1),h===46?s<0?s=i:u!==1&&(u=1):s>-1&&(u=-1)}return s<0||a<0||u===0||u===1&&s===a-1&&s===r+1?"":t.slice(s,a)}function d4(...t){let i=-1,a;for(;++i<t.length;)dr(t[i]),t[i]&&(a=a===void 0?t[i]:a+"/"+t[i]);return a===void 0?".":h4(a)}function h4(t){dr(t);const i=t.codePointAt(0)===47;let a=p4(t,!i);return a.length===0&&!i&&(a="."),a.length>0&&t.codePointAt(t.length-1)===47&&(a+="/"),i?"/"+a:a}function p4(t,i){let a="",r=0,s=-1,u=0,c=-1,h,m;for(;++c<=t.length;){if(c<t.length)h=t.codePointAt(c);else{if(h===47)break;h=47}if(h===47){if(!(s===c-1||u===1))if(s!==c-1&&u===2){if(a.length<2||r!==2||a.codePointAt(a.length-1)!==46||a.codePointAt(a.length-2)!==46){if(a.length>2){if(m=a.lastIndexOf("/"),m!==a.length-1){m<0?(a="",r=0):(a=a.slice(0,m),r=a.length-1-a.lastIndexOf("/")),s=c,u=0;continue}}else if(a.length>0){a="",r=0,s=c,u=0;continue}}i&&(a=a.length>0?a+"/..":"..",r=2)}else a.length>0?a+="/"+t.slice(s+1,c):a=t.slice(s+1,c),r=c-s-1;s=c,u=0}else h===46&&u>-1?u++:u=-1}return a}function dr(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const m4={cwd:g4};function g4(){return"/"}function uf(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function y4(t){if(typeof t=="string")t=new URL(t);else if(!uf(t)){const i=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw i.code="ERR_INVALID_ARG_TYPE",i}if(t.protocol!=="file:"){const i=new TypeError("The URL must be of scheme file");throw i.code="ERR_INVALID_URL_SCHEME",i}return x4(t)}function x4(t){if(t.hostname!==""){const r=new TypeError('File URL host must be "localhost" or empty on darwin');throw r.code="ERR_INVALID_FILE_URL_HOST",r}const i=t.pathname;let a=-1;for(;++a<i.length;)if(i.codePointAt(a)===37&&i.codePointAt(a+1)===50){const r=i.codePointAt(a+2);if(r===70||r===102){const s=new TypeError("File URL path must not include encoded / characters");throw s.code="ERR_INVALID_FILE_URL_PATH",s}}return decodeURIComponent(i)}const qc=["history","path","basename","stem","extname","dirname"];class G0{constructor(i){let a;i?uf(i)?a={path:i}:typeof i=="string"||b4(i)?a={value:i}:a=i:a={},this.cwd="cwd"in a?"":m4.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let r=-1;for(;++r<qc.length;){const u=qc[r];u in a&&a[u]!==void 0&&a[u]!==null&&(this[u]=u==="history"?[...a[u]]:a[u])}let s;for(s in a)qc.includes(s)||(this[s]=a[s])}get basename(){return typeof this.path=="string"?St.basename(this.path):void 0}set basename(i){Vc(i,"basename"),Ic(i,"basename"),this.path=St.join(this.dirname||"",i)}get dirname(){return typeof this.path=="string"?St.dirname(this.path):void 0}set dirname(i){Pg(this.basename,"dirname"),this.path=St.join(i||"",this.basename)}get extname(){return typeof this.path=="string"?St.extname(this.path):void 0}set extname(i){if(Ic(i,"extname"),Pg(this.dirname,"extname"),i){if(i.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(i.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=St.join(this.dirname,this.stem+(i||""))}get path(){return this.history[this.history.length-1]}set path(i){uf(i)&&(i=y4(i)),Vc(i,"path"),this.path!==i&&this.history.push(i)}get stem(){return typeof this.path=="string"?St.basename(this.path,this.extname):void 0}set stem(i){Vc(i,"stem"),Ic(i,"stem"),this.path=St.join(this.dirname||"",i+(this.extname||""))}fail(i,a,r){const s=this.message(i,a,r);throw s.fatal=!0,s}info(i,a,r){const s=this.message(i,a,r);return s.fatal=void 0,s}message(i,a,r){const s=new we(i,a,r);return this.path&&(s.name=this.path+":"+s.name,s.file=this.path),s.fatal=!1,this.messages.push(s),s}toString(i){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(i||void 0).decode(this.value)}}function Ic(t,i){if(t&&t.includes(St.sep))throw new Error("`"+i+"` cannot be a path: did not expect `"+St.sep+"`")}function Vc(t,i){if(!t)throw new Error("`"+i+"` cannot be empty")}function Pg(t,i){if(!t)throw new Error("Setting `"+i+"` requires `path` to be set too")}function b4(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const v4=(function(t){const r=this.constructor.prototype,s=r[t],u=function(){return s.apply(u,arguments)};return Object.setPrototypeOf(u,r),u}),S4={}.hasOwnProperty;class qf extends v4{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=o4()}copy(){const i=new qf;let a=-1;for(;++a<this.attachers.length;){const r=this.attachers[a];i.use(...r)}return i.data(Uc(!0,{},this.namespace)),i}data(i,a){return typeof i=="string"?arguments.length===2?(Xc("data",this.frozen),this.namespace[i]=a,this):S4.call(this.namespace,i)&&this.namespace[i]||void 0:i?(Xc("data",this.frozen),this.namespace=i,this):this.namespace}freeze(){if(this.frozen)return this;const i=this;for(;++this.freezeIndex<this.attachers.length;){const[a,...r]=this.attachers[this.freezeIndex];if(r[0]===!1)continue;r[0]===!0&&(r[0]=void 0);const s=a.call(i,...r);typeof s=="function"&&this.transformers.use(s)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(i){this.freeze();const a=Ho(i),r=this.parser||this.Parser;return Gc("parse",r),r(String(a),a)}process(i,a){const r=this;return this.freeze(),Gc("process",this.parser||this.Parser),Yc("process",this.compiler||this.Compiler),a?s(void 0,a):new Promise(s);function s(u,c){const h=Ho(i),m=r.parse(h);r.run(m,h,function(y,g,b){if(y||!g||!b)return p(y);const S=g,E=r.stringify(S,b);k4(E)?b.value=E:b.result=E,p(y,b)});function p(y,g){y||!g?c(y):u?u(g):a(void 0,g)}}}processSync(i){let a=!1,r;return this.freeze(),Gc("processSync",this.parser||this.Parser),Yc("processSync",this.compiler||this.Compiler),this.process(i,s),Wg("processSync","process",a),r;function s(u,c){a=!0,Kg(u),r=c}}run(i,a,r){Jg(i),this.freeze();const s=this.transformers;return!r&&typeof a=="function"&&(r=a,a=void 0),r?u(void 0,r):new Promise(u);function u(c,h){const m=Ho(a);s.run(i,m,p);function p(y,g,b){const S=g||i;y?h(y):c?c(S):r(void 0,S,b)}}}runSync(i,a){let r=!1,s;return this.run(i,a,u),Wg("runSync","run",r),s;function u(c,h){Kg(c),s=h,r=!0}}stringify(i,a){this.freeze();const r=Ho(a),s=this.compiler||this.Compiler;return Yc("stringify",s),Jg(i),s(i,r)}use(i,...a){const r=this.attachers,s=this.namespace;if(Xc("use",this.frozen),i!=null)if(typeof i=="function")m(i,a);else if(typeof i=="object")Array.isArray(i)?h(i):c(i);else throw new TypeError("Expected usable value, not `"+i+"`");return this;function u(p){if(typeof p=="function")m(p,[]);else if(typeof p=="object")if(Array.isArray(p)){const[y,...g]=p;m(y,g)}else c(p);else throw new TypeError("Expected usable value, not `"+p+"`")}function c(p){if(!("plugins"in p)&&!("settings"in p))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");h(p.plugins),p.settings&&(s.settings=Uc(!0,s.settings,p.settings))}function h(p){let y=-1;if(p!=null)if(Array.isArray(p))for(;++y<p.length;){const g=p[y];u(g)}else throw new TypeError("Expected a list of plugins, not `"+p+"`")}function m(p,y){let g=-1,b=-1;for(;++g<r.length;)if(r[g][0]===p){b=g;break}if(b===-1)r.push([p,...y]);else if(y.length>0){let[S,...E]=y;const z=r[b][1];sf(z)&&sf(S)&&(S=Uc(!0,z,S)),r[b]=[p,S,...E]}}}}const w4=new qf().freeze();function Gc(t,i){if(typeof i!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Yc(t,i){if(typeof i!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Xc(t,i){if(i)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function Jg(t){if(!sf(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function Wg(t,i,a){if(!a)throw new Error("`"+t+"` finished async. Use `"+i+"` instead")}function Ho(t){return A4(t)?t:new G0(t)}function A4(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function k4(t){return typeof t=="string"||E4(t)}function E4(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const C4="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",n1=[],e1={allowDangerousHtml:!0},T4=/^(https?|ircs?|mailto|xmpp)$/i,N4=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function _4(t){const i=z4(t),a=R4(t);return M4(i.runSync(i.parse(a),a),t)}function z4(t){const i=t.rehypePlugins||n1,a=t.remarkPlugins||n1,r=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...e1}:e1;return w4().use(c3).use(a).use(a4,r).use(i)}function R4(t){const i=t.children||"",a=new G0;return typeof i=="string"&&(a.value=i),a}function M4(t,i){const a=i.allowedElements,r=i.allowElement,s=i.components,u=i.disallowedElements,c=i.skipHtml,h=i.unwrapDisallowed,m=i.urlTransform||j4;for(const y of N4)Object.hasOwn(i,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+C4+y.id,void 0);return Uf(t,p),FA(t,{Fragment:v.Fragment,components:s,ignoreInvalidStyle:!0,jsx:v.jsx,jsxs:v.jsxs,passKeys:!0,passNode:!0});function p(y,g,b){if(y.type==="raw"&&b&&typeof g=="number")return c?b.children.splice(g,1):b.children[g]={type:"text",value:y.value},g;if(y.type==="element"){let S;for(S in Oc)if(Object.hasOwn(Oc,S)&&Object.hasOwn(y.properties,S)){const E=y.properties[S],z=Oc[S];(z===null||z.includes(y.tagName))&&(y.properties[S]=m(String(E||""),S,y))}}if(y.type==="element"){let S=a?!a.includes(y.tagName):u?u.includes(y.tagName):!1;if(!S&&r&&typeof g=="number"&&(S=!r(y,g,b)),S&&b&&typeof g=="number")return h&&y.children?b.children.splice(g,1,...y.children):b.children.splice(g,1),g}}}function j4(t){const i=t.indexOf(":"),a=t.indexOf("?"),r=t.indexOf("#"),s=t.indexOf("/");return i===-1||s!==-1&&i>s||a!==-1&&i>a||r!==-1&&i>r||T4.test(t.slice(0,i))?t:""}function t1(t,i){const a=String(t);if(typeof i!="string")throw new TypeError("Expected character");let r=0,s=a.indexOf(i);for(;s!==-1;)r++,s=a.indexOf(i,s+i.length);return r}function D4(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function O4(t,i,a){const s=is((a||{}).ignore||[]),u=L4(i);let c=-1;for(;++c<u.length;)V0(t,"text",h);function h(p,y){let g=-1,b;for(;++g<y.length;){const S=y[g],E=b?b.children:void 0;if(s(S,E?E.indexOf(S):void 0,b))return;b=S}if(b)return m(p,y)}function m(p,y){const g=y[y.length-1],b=u[c][0],S=u[c][1];let E=0;const T=g.children.indexOf(p);let N=!1,j=[];b.lastIndex=0;let D=b.exec(p.value);for(;D;){const Z=D.index,W={index:D.index,input:D.input,stack:[...y,p]};let q=S(...D,W);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?b.lastIndex=Z+1:(E!==Z&&j.push({type:"text",value:p.value.slice(E,Z)}),Array.isArray(q)?j.push(...q):q&&j.push(q),E=Z+D[0].length,N=!0),!b.global)break;D=b.exec(p.value)}return N?(E<p.value.length&&j.push({type:"text",value:p.value.slice(E)}),g.children.splice(T,1,...j)):j=[p],T+j.length}}function L4(t){const i=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const a=!t[0]||Array.isArray(t[0])?t:[t];let r=-1;for(;++r<a.length;){const s=a[r];i.push([B4(s[0]),H4(s[1])])}return i}function B4(t){return typeof t=="string"?new RegExp(D4(t),"g"):t}function H4(t){return typeof t=="function"?t:function(){return t}}const Qc="phrasing",Fc=["autolink","link","image","label"];function U4(){return{transforms:[Q4],enter:{literalAutolink:I4,literalAutolinkEmail:Zc,literalAutolinkHttp:Zc,literalAutolinkWww:Zc},exit:{literalAutolink:X4,literalAutolinkEmail:Y4,literalAutolinkHttp:V4,literalAutolinkWww:G4}}}function q4(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Qc,notInConstruct:Fc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Qc,notInConstruct:Fc},{character:":",before:"[ps]",after:"\\/",inConstruct:Qc,notInConstruct:Fc}]}}function I4(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Zc(t){this.config.enter.autolinkProtocol.call(this,t)}function V4(t){this.config.exit.autolinkProtocol.call(this,t)}function G4(t){this.config.exit.data.call(this,t);const i=this.stack[this.stack.length-1];i.type,i.url="http://"+this.sliceSerialize(t)}function Y4(t){this.config.exit.autolinkEmail.call(this,t)}function X4(t){this.exit(t)}function Q4(t){O4(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,F4],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),Z4]],{ignore:["link","linkReference"]})}function F4(t,i,a,r,s){let u="";if(!Y0(s)||(/^w/i.test(i)&&(a=i+a,i="",u="http://"),!K4(a)))return!1;const c=$4(a+r);if(!c[0])return!1;const h={type:"link",title:null,url:u+i+c[0],children:[{type:"text",value:i+c[0]}]};return c[1]?[h,{type:"text",value:c[1]}]:h}function Z4(t,i,a,r){return!Y0(r,!0)||/[-\d_]$/.test(a)?!1:{type:"link",title:null,url:"mailto:"+i+"@"+a,children:[{type:"text",value:i+"@"+a}]}}function K4(t){const i=t.split(".");return!(i.length<2||i[i.length-1]&&(/_/.test(i[i.length-1])||!/[a-zA-Z\d]/.test(i[i.length-1]))||i[i.length-2]&&(/_/.test(i[i.length-2])||!/[a-zA-Z\d]/.test(i[i.length-2])))}function $4(t){const i=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!i)return[t,void 0];t=t.slice(0,i.index);let a=i[0],r=a.indexOf(")");const s=t1(t,"(");let u=t1(t,")");for(;r!==-1&&s>u;)t+=a.slice(0,r+1),a=a.slice(r+1),r=a.indexOf(")"),u++;return[t,a]}function Y0(t,i){const a=t.input.charCodeAt(t.index-1);return(t.index===0||$l(a)||ts(a))&&(!i||a!==47)}X0.peek=i6;function P4(){this.buffer()}function J4(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function W4(){this.buffer()}function n6(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function e6(t){const i=this.resume(),a=this.stack[this.stack.length-1];a.type,a.identifier=pt(this.sliceSerialize(t)).toLowerCase(),a.label=i}function t6(t){this.exit(t)}function l6(t){const i=this.resume(),a=this.stack[this.stack.length-1];a.type,a.identifier=pt(this.sliceSerialize(t)).toLowerCase(),a.label=i}function a6(t){this.exit(t)}function i6(){return"["}function X0(t,i,a,r){const s=a.createTracker(r);let u=s.move("[^");const c=a.enter("footnoteReference"),h=a.enter("reference");return u+=s.move(a.safe(a.associationId(t),{after:"]",before:u})),h(),c(),u+=s.move("]"),u}function r6(){return{enter:{gfmFootnoteCallString:P4,gfmFootnoteCall:J4,gfmFootnoteDefinitionLabelString:W4,gfmFootnoteDefinition:n6},exit:{gfmFootnoteCallString:e6,gfmFootnoteCall:t6,gfmFootnoteDefinitionLabelString:l6,gfmFootnoteDefinition:a6}}}function o6(t){let i=!1;return t&&t.firstLineBlank&&(i=!0),{handlers:{footnoteDefinition:a,footnoteReference:X0},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function a(r,s,u,c){const h=u.createTracker(c);let m=h.move("[^");const p=u.enter("footnoteDefinition"),y=u.enter("label");return m+=h.move(u.safe(u.associationId(r),{before:m,after:"]"})),y(),m+=h.move("]:"),r.children&&r.children.length>0&&(h.shift(4),m+=h.move((i?`
`:" ")+u.indentLines(u.containerFlow(r,h.current()),i?Q0:s6))),p(),m}}function s6(t,i,a){return i===0?t:Q0(t,i,a)}function Q0(t,i,a){return(a?"":"    ")+t}const u6=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];F0.peek=p6;function c6(){return{canContainEols:["delete"],enter:{strikethrough:d6},exit:{strikethrough:h6}}}function f6(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:u6}],handlers:{delete:F0}}}function d6(t){this.enter({type:"delete",children:[]},t)}function h6(t){this.exit(t)}function F0(t,i,a,r){const s=a.createTracker(r),u=a.enter("strikethrough");let c=s.move("~~");return c+=a.containerPhrasing(t,{...s.current(),before:c,after:"~"}),c+=s.move("~~"),u(),c}function p6(){return"~"}function m6(t){return t.length}function g6(t,i){const a=i||{},r=(a.align||[]).concat(),s=a.stringLength||m6,u=[],c=[],h=[],m=[];let p=0,y=-1;for(;++y<t.length;){const z=[],T=[];let N=-1;for(t[y].length>p&&(p=t[y].length);++N<t[y].length;){const j=y6(t[y][N]);if(a.alignDelimiters!==!1){const D=s(j);T[N]=D,(m[N]===void 0||D>m[N])&&(m[N]=D)}z.push(j)}c[y]=z,h[y]=T}let g=-1;if(typeof r=="object"&&"length"in r)for(;++g<p;)u[g]=l1(r[g]);else{const z=l1(r);for(;++g<p;)u[g]=z}g=-1;const b=[],S=[];for(;++g<p;){const z=u[g];let T="",N="";z===99?(T=":",N=":"):z===108?T=":":z===114&&(N=":");let j=a.alignDelimiters===!1?1:Math.max(1,m[g]-T.length-N.length);const D=T+"-".repeat(j)+N;a.alignDelimiters!==!1&&(j=T.length+j+N.length,j>m[g]&&(m[g]=j),S[g]=j),b[g]=D}c.splice(1,0,b),h.splice(1,0,S),y=-1;const E=[];for(;++y<c.length;){const z=c[y],T=h[y];g=-1;const N=[];for(;++g<p;){const j=z[g]||"";let D="",Z="";if(a.alignDelimiters!==!1){const W=m[g]-(T[g]||0),q=u[g];q===114?D=" ".repeat(W):q===99?W%2?(D=" ".repeat(W/2+.5),Z=" ".repeat(W/2-.5)):(D=" ".repeat(W/2),Z=D):Z=" ".repeat(W)}a.delimiterStart!==!1&&!g&&N.push("|"),a.padding!==!1&&!(a.alignDelimiters===!1&&j==="")&&(a.delimiterStart!==!1||g)&&N.push(" "),a.alignDelimiters!==!1&&N.push(D),N.push(j),a.alignDelimiters!==!1&&N.push(Z),a.padding!==!1&&N.push(" "),(a.delimiterEnd!==!1||g!==p-1)&&N.push("|")}E.push(a.delimiterEnd===!1?N.join("").replace(/ +$/,""):N.join(""))}return E.join(`
`)}function y6(t){return t==null?"":String(t)}function l1(t){const i=typeof t=="string"?t.codePointAt(0):0;return i===67||i===99?99:i===76||i===108?108:i===82||i===114?114:0}function x6(t,i,a,r){const s=a.enter("blockquote"),u=a.createTracker(r);u.move("> "),u.shift(2);const c=a.indentLines(a.containerFlow(t,u.current()),b6);return s(),c}function b6(t,i,a){return">"+(a?"":" ")+t}function v6(t,i){return a1(t,i.inConstruct,!0)&&!a1(t,i.notInConstruct,!1)}function a1(t,i,a){if(typeof i=="string"&&(i=[i]),!i||i.length===0)return a;let r=-1;for(;++r<i.length;)if(t.includes(i[r]))return!0;return!1}function i1(t,i,a,r){let s=-1;for(;++s<a.unsafe.length;)if(a.unsafe[s].character===`
`&&v6(a.stack,a.unsafe[s]))return/[ \t]/.test(r.before)?"":" ";return`\\
`}function S6(t,i){const a=String(t);let r=a.indexOf(i),s=r,u=0,c=0;if(typeof i!="string")throw new TypeError("Expected substring");for(;r!==-1;)r===s?++u>c&&(c=u):u=1,s=r+i.length,r=a.indexOf(i,s);return c}function w6(t,i){return!!(i.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function A6(t){const i=t.options.fence||"`";if(i!=="`"&&i!=="~")throw new Error("Cannot serialize code with `"+i+"` for `options.fence`, expected `` ` `` or `~`");return i}function k6(t,i,a,r){const s=A6(a),u=t.value||"",c=s==="`"?"GraveAccent":"Tilde";if(w6(t,a)){const g=a.enter("codeIndented"),b=a.indentLines(u,E6);return g(),b}const h=a.createTracker(r),m=s.repeat(Math.max(S6(u,s)+1,3)),p=a.enter("codeFenced");let y=h.move(m);if(t.lang){const g=a.enter(`codeFencedLang${c}`);y+=h.move(a.safe(t.lang,{before:y,after:" ",encode:["`"],...h.current()})),g()}if(t.lang&&t.meta){const g=a.enter(`codeFencedMeta${c}`);y+=h.move(" "),y+=h.move(a.safe(t.meta,{before:y,after:`
`,encode:["`"],...h.current()})),g()}return y+=h.move(`
`),u&&(y+=h.move(u+`
`)),y+=h.move(m),p(),y}function E6(t,i,a){return(a?"":"    ")+t}function If(t){const i=t.options.quote||'"';if(i!=='"'&&i!=="'")throw new Error("Cannot serialize title with `"+i+"` for `options.quote`, expected `\"`, or `'`");return i}function C6(t,i,a,r){const s=If(a),u=s==='"'?"Quote":"Apostrophe",c=a.enter("definition");let h=a.enter("label");const m=a.createTracker(r);let p=m.move("[");return p+=m.move(a.safe(a.associationId(t),{before:p,after:"]",...m.current()})),p+=m.move("]: "),h(),!t.url||/[\0- \u007F]/.test(t.url)?(h=a.enter("destinationLiteral"),p+=m.move("<"),p+=m.move(a.safe(t.url,{before:p,after:">",...m.current()})),p+=m.move(">")):(h=a.enter("destinationRaw"),p+=m.move(a.safe(t.url,{before:p,after:t.title?" ":`
`,...m.current()}))),h(),t.title&&(h=a.enter(`title${u}`),p+=m.move(" "+s),p+=m.move(a.safe(t.title,{before:p,after:s,...m.current()})),p+=m.move(s),h()),c(),p}function T6(t){const i=t.options.emphasis||"*";if(i!=="*"&&i!=="_")throw new Error("Cannot serialize emphasis with `"+i+"` for `options.emphasis`, expected `*`, or `_`");return i}function rr(t){return"&#x"+t.toString(16).toUpperCase()+";"}function $o(t,i,a){const r=Za(t),s=Za(i);return r===void 0?s===void 0?a==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:r===1?s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Z0.peek=N6;function Z0(t,i,a,r){const s=T6(a),u=a.enter("emphasis"),c=a.createTracker(r),h=c.move(s);let m=c.move(a.containerPhrasing(t,{after:s,before:h,...c.current()}));const p=m.charCodeAt(0),y=$o(r.before.charCodeAt(r.before.length-1),p,s);y.inside&&(m=rr(p)+m.slice(1));const g=m.charCodeAt(m.length-1),b=$o(r.after.charCodeAt(0),g,s);b.inside&&(m=m.slice(0,-1)+rr(g));const S=c.move(s);return u(),a.attentionEncodeSurroundingInfo={after:b.outside,before:y.outside},h+m+S}function N6(t,i,a){return a.options.emphasis||"*"}function _6(t,i){let a=!1;return Uf(t,function(r){if("value"in r&&/\r?\n|\r/.test(r.value)||r.type==="break")return a=!0,rf}),!!((!t.depth||t.depth<3)&&Mf(t)&&(i.options.setext||a))}function z6(t,i,a,r){const s=Math.max(Math.min(6,t.depth||1),1),u=a.createTracker(r);if(_6(t,a)){const y=a.enter("headingSetext"),g=a.enter("phrasing"),b=a.containerPhrasing(t,{...u.current(),before:`
`,after:`
`});return g(),y(),b+`
...
`,...u.current()});return/^[\t ]/.test(p)&&(p=rr(p.charCodeAt(0))+p.slice(1)),p=p?c+" "+p:c,a.options.closeAtx&&(p+=" "+c),m(),h(),p}K0.peek=R6;function K0(t){return t.value||""}function R6(){return"<"}$0.peek=M6;function $0(t,i,a,r){const s=If(a),u=s==='"'?"Quote":"Apostrophe",c=a.enter("image");let h=a.enter("label");const m=a.createTracker(r);let p=m.move("![");return p+=m.move(a.safe(t.alt,{before:p,after:"]",...m.current()})),p+=m.move("]("),h(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(h=a.enter("destinationLiteral"),p+=m.move("<"),p+=m.move(a.safe(t.url,{before:p,after:">",...m.current()})),p+=m.move(">")):(h=a.enter("destinationRaw"),p+=m.move(a.safe(t.url,{before:p,after:t.title?" ":")",...m.current()}))),h(),t.title&&(h=a.enter(`title${u}`),p+=m.move(" "+s),p+=m.move(a.safe(t.title,{before:p,after:s,...m.current()})),p+=m.move(s),h()),p+=m.move(")"),c(),p}function M6(){return"!"}P0.peek=j6;function P0(t,i,a,r){const s=t.referenceType,u=a.enter("imageReference");let c=a.enter("label");const h=a.createTracker(r);let m=h.move("![");const p=a.safe(t.alt,{before:m,after:"]",...h.current()});m+=h.move(p+"]["),c();const y=a.stack;a.stack=[],c=a.enter("reference");const g=a.safe(a.associationId(t),{before:m,after:"]",...h.current()});return c(),a.stack=y,u(),s==="full"||!p||p!==g?m+=h.move(g+"]"):s==="shortcut"?m=m.slice(0,-1):m+=h.move("]"),m}function j6(){return"!"}J0.peek=D6;function J0(t,i,a){let r=t.value||"",s="`",u=-1;for(;new RegExp("(^|[^`])"+s+"([^`]|$)").test(r);)s+="`";for(/[^ \r\n]/.test(r)&&(/^[ \r\n]/.test(r)&&/[ \r\n]$/.test(r)||/^`|`$/.test(r))&&(r=" "+r+" ");++u<a.unsafe.length;){const c=a.unsafe[u],h=a.compilePattern(c);let m;if(c.atBreak)for(;m=h.exec(r);){let p=m.index;r.charCodeAt(p)===10&&r.charCodeAt(p-1)===13&&p--,r=r.slice(0,p)+" "+r.slice(m.index+1)}}return s+r+s}function D6(){return"`"}function W0(t,i){const a=Mf(t);return!!(!i.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(a===t.url||"mailto:"+a===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}ny.peek=O6;function ny(t,i,a,r){const s=If(a),u=s==='"'?"Quote":"Apostrophe",c=a.createTracker(r);let h,m;if(W0(t,a)){const y=a.stack;a.stack=[],h=a.enter("autolink");let g=c.move("<");return g+=c.move(a.containerPhrasing(t,{before:g,after:">",...c.current()})),g+=c.move(">"),h(),a.stack=y,g}h=a.enter("link"),m=a.enter("label");let p=c.move("[");return p+=c.move(a.containerPhrasing(t,{before:p,after:"](",...c.current()})),p+=c.move("]("),m(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(m=a.enter("destinationLiteral"),p+=c.move("<"),p+=c.move(a.safe(t.url,{before:p,after:">",...c.current()})),p+=c.move(">")):(m=a.enter("destinationRaw"),p+=c.move(a.safe(t.url,{before:p,after:t.title?" ":")",...c.current()}))),m(),t.title&&(m=a.enter(`title${u}`),p+=c.move(" "+s),p+=c.move(a.safe(t.title,{before:p,after:s,...c.current()})),p+=c.move(s),m()),p+=c.move(")"),h(),p}function O6(t,i,a){return W0(t,a)?"<":"["}ey.peek=L6;function ey(t,i,a,r){const s=t.referenceType,u=a.enter("linkReference");let c=a.enter("label");const h=a.createTracker(r);let m=h.move("[");const p=a.containerPhrasing(t,{before:m,after:"]",...h.current()});m+=h.move(p+"]["),c();const y=a.stack;a.stack=[],c=a.enter("reference");const g=a.safe(a.associationId(t),{before:m,after:"]",...h.current()});return c(),a.stack=y,u(),s==="full"||!p||p!==g?m+=h.move(g+"]"):s==="shortcut"?m=m.slice(0,-1):m+=h.move("]"),m}function L6(){return"["}function Vf(t){const i=t.options.bullet||"*";if(i!=="*"&&i!=="+"&&i!=="-")throw new Error("Cannot serialize items with `"+i+"` for `options.bullet`, expected `*`, `+`, or `-`");return i}function B6(t){const i=Vf(t),a=t.options.bulletOther;if(!a)return i==="*"?"-":"*";if(a!=="*"&&a!=="+"&&a!=="-")throw new Error("Cannot serialize items with `"+a+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(a===i)throw new Error("Expected `bullet` (`"+i+"`) and `bulletOther` (`"+a+"`) to be different");return a}function H6(t){const i=t.options.bulletOrdered||".";if(i!=="."&&i!==")")throw new Error("Cannot serialize items with `"+i+"` for `options.bulletOrdered`, expected `.` or `)`");return i}function ty(t){const i=t.options.rule||"*";if(i!=="*"&&i!=="-"&&i!=="_")throw new Error("Cannot serialize rules with `"+i+"` for `options.rule`, expected `*`, `-`, or `_`");return i}function U6(t,i,a,r){const s=a.enter("list"),u=a.bulletCurrent;let c=t.ordered?H6(a):Vf(a);const h=t.ordered?c==="."?")":".":B6(a);let m=i&&a.bulletLastUsed?c===a.bulletLastUsed:!1;if(!t.ordered){const y=t.children?t.children[0]:void 0;if((c==="*"||c==="-")&&y&&(!y.children||!y.children[0])&&a.stack[a.stack.length-1]==="list"&&a.stack[a.stack.length-2]==="listItem"&&a.stack[a.stack.length-3]==="list"&&a.stack[a.stack.length-4]==="listItem"&&a.indexStack[a.indexStack.length-1]===0&&a.indexStack[a.indexStack.length-2]===0&&a.indexStack[a.indexStack.length-3]===0&&(m=!0),ty(a)===c&&y){let g=-1;for(;++g<t.children.length;){const b=t.children[g];if(b&&b.type==="listItem"&&b.children&&b.children[0]&&b.children[0].type==="thematicBreak"){m=!0;break}}}}m&&(c=h),a.bulletCurrent=c;const p=a.containerFlow(t,r);return a.bulletLastUsed=c,a.bulletCurrent=u,s(),p}function q6(t){const i=t.options.listItemIndent||"one";if(i!=="tab"&&i!=="one"&&i!=="mixed")throw new Error("Cannot serialize items with `"+i+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return i}function I6(t,i,a,r){const s=q6(a);let u=a.bulletCurrent||Vf(a);i&&i.type==="list"&&i.ordered&&(u=(typeof i.start=="number"&&i.start>-1?i.start:1)+(a.options.incrementListMarker===!1?0:i.children.indexOf(t))+u);let c=u.length+1;(s==="tab"||s==="mixed"&&(i&&i.type==="list"&&i.spread||t.spread))&&(c=Math.ceil(c/4)*4);const h=a.createTracker(r);h.move(u+" ".repeat(c-u.length)),h.shift(c);const m=a.enter("listItem"),p=a.indentLines(a.containerFlow(t,h.current()),y);return m(),p;function y(g,b,S){return b?(S?"":" ".repeat(c))+g:(S?u:u+" ".repeat(c-u.length))+g}}function V6(t,i,a,r){const s=a.enter("paragraph"),u=a.enter("phrasing"),c=a.containerPhrasing(t,r);return u(),s(),c}const G6=is(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function Y6(t,i,a,r){return(t.children.some(function(c){return G6(c)})?a.containerPhrasing:a.containerFlow).call(a,t,r)}function X6(t){const i=t.options.strong||"*";if(i!=="*"&&i!=="_")throw new Error("Cannot serialize strong with `"+i+"` for `options.strong`, expected `*`, or `_`");return i}ly.peek=Q6;function ly(t,i,a,r){const s=X6(a),u=a.enter("strong"),c=a.createTracker(r),h=c.move(s+s);let m=c.move(a.containerPhrasing(t,{after:s,before:h,...c.current()}));const p=m.charCodeAt(0),y=$o(r.before.charCodeAt(r.before.length-1),p,s);y.inside&&(m=rr(p)+m.slice(1));const g=m.charCodeAt(m.length-1),b=$o(r.after.charCodeAt(0),g,s);b.inside&&(m=m.slice(0,-1)+rr(g));const S=c.move(s+s);return u(),a.attentionEncodeSurroundingInfo={after:b.outside,before:y.outside},h+m+S}function Q6(t,i,a){return a.options.strong||"*"}function F6(t,i,a,r){return a.safe(t.value,r)}function Z6(t){const i=t.options.ruleRepetition||3;if(i<3)throw new Error("Cannot serialize rules with repetition `"+i+"` for `options.ruleRepetition`, expected `3` or more");return i}function K6(t,i,a){const r=(ty(a)+(a.options.ruleSpaces?" ":"")).repeat(Z6(a));return a.options.ruleSpaces?r.slice(0,-1):r}const ay={blockquote:x6,break:i1,code:k6,definition:C6,emphasis:Z0,hardBreak:i1,heading:z6,html:K0,image:$0,imageReference:P0,inlineCode:J0,link:ny,linkReference:ey,list:U6,listItem:I6,paragraph:V6,root:Y6,strong:ly,text:F6,thematicBreak:K6};function $6(){return{enter:{table:P6,tableData:r1,tableHeader:r1,tableRow:W6},exit:{codeText:nC,table:J6,tableData:Kc,tableHeader:Kc,tableRow:Kc}}}function P6(t){const i=t._align;this.enter({type:"table",align:i.map(function(a){return a==="none"?null:a}),children:[]},t),this.data.inTable=!0}function J6(t){this.exit(t),this.data.inTable=void 0}function W6(t){this.enter({type:"tableRow",children:[]},t)}function Kc(t){this.exit(t)}function r1(t){this.enter({type:"tableCell",children:[]},t)}function nC(t){let i=this.resume();this.data.inTable&&(i=i.replace(/\\([\\|])/g,eC));const a=this.stack[this.stack.length-1];a.type,a.value=i,this.exit(t)}function eC(t,i){return i==="|"?i:t}function tC(t){const i=t||{},a=i.tableCellPadding,r=i.tablePipeAlign,s=i.stringLength,u=a?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
