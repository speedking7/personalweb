...
`});const p={type:"element",tagName:"li",properties:s,children:c};return t.patch(i,p),t.applyData(i,p)}function w3(t){let i=!1;if(t.type==="list"){i=t.spread||!1;const a=t.children;let r=-1;for(;!i&&++r<a.length;)i=By(a[r])}return i}function By(t){const i=t.spread;return i??t.children.length>1}function A3(t,i){const a={},r=t.all(i);let u=-1;for(typeof i.start=="number"&&i.start!==1&&(a.start=i.start);++u<r.length;){const c=r[u];if(c.type==="element"&&c.tagName==="li"&&c.properties&&Array.isArray(c.properties.className)&&c.properties.className.includes("task-list-item")){a.className=["contains-task-list"];break}}const s={type:"element",tagName:i.ordered?"ol":"ul",properties:a,children:t.wrap(r,!0)};return t.patch(i,s),t.applyData(i,s)}function k3(t,i){const a={type:"element",tagName:"p",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}function E3(t,i){const a={type:"root",children:t.wrap(t.all(i))};return t.patch(i,a),t.applyData(i,a)}function C3(t,i){const a={type:"element",tagName:"strong",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}function T3(t,i){const a=t.all(i),r=a.shift(),u=[];if(r){const c={type:"element",tagName:"thead",properties:{},children:t.wrap([r],!0)};t.patch(i.children[0],c),u.push(c)}if(a.length>0){const c={type:"element",tagName:"tbody",properties:{},children:t.wrap(a,!0)},h=Nf(i.children[1]),m=gy(i.children[i.children.length-1]);h&&m&&(c.position={start:h,end:m}),u.push(c)}const s={type:"element",tagName:"table",properties:{},children:t.wrap(u,!0)};return t.patch(i,s),t.applyData(i,s)}function N3(t,i,a){const r=a?a.children:void 0,s=(r?r.indexOf(i):1)===0?"th":"td",c=a&&a.type==="table"?a.align:void 0,h=c?c.length:i.children.length;let m=-1;const p=[];for(;++m<h;){const g=i.children[m],b={},S=c?c[m]:void 0;S&&(b.align=S);let E={type:"element",tagName:s,properties:b,children:[]};g&&(E.children=t.all(g),t.patch(g,E),E=t.applyData(g,E)),p.push(E)}const y={type:"element",tagName:"tr",properties:{},children:t.wrap(p,!0)};return t.patch(i,y),t.applyData(i,y)}function _3(t,i){const a={type:"element",tagName:"td",properties:{},children:t.all(i)};return t.patch(i,a),t.applyData(i,a)}const Ig=9,Vg=32;function z3(t){const i=String(t),a=/\r?\n|\r/g;let r=a.exec(i),u=0;const s=[];for(;r;)s.push(Gg(i.slice(u,r.index),u>0,!0),r[0]),u=r.index+r[0].length,r=a.exec(i);return s.push(Gg(i.slice(u),u>0,!1)),s.join("")}function Gg(t,i,a){let r=0,u=t.length;if(i){let s=t.codePointAt(r);for(;s===Ig||s===Vg;)r++,s=t.codePointAt(r)}if(a){let s=t.codePointAt(u-1);for(;s===Ig||s===Vg;)u--,s=t.codePointAt(u-1)}return u>r?t.slice(r,u):""}function R3(t,i){const a={type:"text",value:z3(String(i.value))};return t.patch(i,a),t.applyData(i,a)}function M3(t,i){const a={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(i,a),t.applyData(i,a)}const D3={blockquote:u3,break:s3,code:c3,delete:f3,emphasis:d3,footnoteReference:h3,heading:p3,html:m3,imageReference:g3,image:y3,inlineCode:x3,linkReference:b3,link:v3,listItem:S3,list:A3,paragraph:k3,root:E3,strong:C3,table:T3,tableCell:_3,tableRow:N3,text:R3,thematicBreak:M3,toml:Lo,yaml:Lo,definition:Lo,footnoteDefinition:Lo};function Lo(){}const Hy=-1,au=0,lr=1,Zo=2,Of=3,Lf=4,Bf=5,Hf=6,Uy=7,qy=8,Yg=typeof self=="object"?self:globalThis,j3=(t,i)=>{const a=(u,s)=>(t.set(s,u),u),r=u=>{if(t.has(u))return t.get(u);const[s,c]=i[u];switch(s){case au:case Hy:return a(c,u);case lr:{const h=a([],u);for(const m of c)h.push(r(m));return h}case Zo:{const h=a({},u);for(const[m,p]of c)h[r(m)]=r(p);return h}case Of:return a(new Date(c),u);case Lf:{const{source:h,flags:m}=c;return a(new RegExp(h,m),u)}case Bf:{const h=a(new Map,u);for(const[m,p]of c)h.set(r(m),r(p));return h}case Hf:{const h=a(new Set,u);for(const m of c)h.add(r(m));return h}case Uy:{const{name:h,message:m}=c;return a(new Yg[h](m),u)}case qy:return a(BigInt(c),u);case"BigInt":return a(Object(BigInt(c)),u);case"ArrayBuffer":return a(new Uint8Array(c).buffer,c);case"DataView":{const{buffer:h}=new Uint8Array(c);return a(new DataView(h),c)}}return a(new Yg[s](c),u)};return r},Xg=t=>j3(new Map,t)(0),Ga="",{toString:O3}={},{keys:L3}=Object,Wi=t=>{const i=typeof t;if(i!=="object"||!t)return[au,i];const a=O3.call(t).slice(8,-1);switch(a){case"Array":return[lr,Ga];case"Object":return[Zo,Ga];case"Date":return[Of,Ga];case"RegExp":return[Lf,Ga];case"Map":return[Bf,Ga];case"Set":return[Hf,Ga];case"DataView":return[lr,a]}return a.includes("Array")?[lr,a]:a.includes("Error")?[Uy,a]:[Zo,a]},Bo=([t,i])=>t===au&&(i==="function"||i==="symbol"),B3=(t,i,a,r)=>{const u=(c,h)=>{const m=r.push(c)-1;return a.set(h,m),m},s=c=>{if(a.has(c))return a.get(c);let[h,m]=Wi(c);switch(h){case au:{let y=c;switch(m){case"bigint":h=qy,y=c.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+m);y=null;break;case"undefined":return u([Hy],c)}return u([h,y],c)}case lr:{if(m){let b=c;return m==="DataView"?b=new Uint8Array(c.buffer):m==="ArrayBuffer"&&(b=new Uint8Array(c)),u([m,[...b]],c)}const y=[],g=u([h,y],c);for(const b of c)y.push(s(b));return g}case Zo:{if(m)switch(m){case"BigInt":return u([m,c.toString()],c);case"Boolean":case"Number":case"String":return u([m,c.valueOf()],c)}if(i&&"toJSON"in c)return s(c.toJSON());const y=[],g=u([h,y],c);for(const b of L3(c))(t||!Bo(Wi(c[b])))&&y.push([s(b),s(c[b])]);return g}case Of:return u([h,c.toISOString()],c);case Lf:{const{source:y,flags:g}=c;return u([h,{source:y,flags:g}],c)}case Bf:{const y=[],g=u([h,y],c);for(const[b,S]of c)(t||!(Bo(Wi(b))||Bo(Wi(S))))&&y.push([s(b),s(S)]);return g}case Hf:{const y=[],g=u([h,y],c);for(const b of c)(t||!Bo(Wi(b)))&&y.push(s(b));return g}}const{message:p}=c;return u([h,{name:m,message:p}],c)};return s},Qg=(t,{json:i,lossy:a}={})=>{const r=[];return B3(!(i||a),!!i,new Map,r)(t),r},Ko=typeof structuredClone=="function"?(t,i)=>i&&("json"in i||"lossy"in i)?Xg(Qg(t,i)):structuredClone(t):(t,i)=>Xg(Qg(t,i));function H3(t,i){const a=[{type:"text",value:"↩"}];return i>1&&a.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(i)}]}),a}function U3(t,i){return"Back to reference "+(t+1)+(i>1?"-"+i:"")}function q3(t){const i=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",a=t.options.footnoteBackContent||H3,r=t.options.footnoteBackLabel||U3,u=t.options.footnoteLabel||"Footnotes",s=t.options.footnoteLabelTagName||"h2",c=t.options.footnoteLabelProperties||{className:["sr-only"]},h=[];let m=-1;for(;++m<t.footnoteOrder.length;){const p=t.footnoteById.get(t.footnoteOrder[m]);if(!p)continue;const y=t.all(p),g=String(p.identifier).toUpperCase(),b=Ja(g.toLowerCase());let S=0;const E=[],z=t.footnoteCounts.get(g);for(;z!==void 0&&++S<=z;){E.length>0&&E.push({type:"text",value:" "});let D=typeof a=="string"?a:a(m,S);typeof D=="string"&&(D={type:"text",value:D}),E.push({type:"element",tagName:"a",properties:{href:"#"+i+"fnref-"+b+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof r=="string"?r:r(m,S),className:["data-footnote-backref"]},children:Array.isArray(D)?D:[D]})}const T=y[y.length-1];if(T&&T.type==="element"&&T.tagName==="p"){const D=T.children[T.children.length-1];D&&D.type==="text"?D.value+=" ":T.children.push({type:"text",value:" "}),T.children.push(...E)}else y.push(...E);const N={type:"element",tagName:"li",properties:{id:i+"fn-"+b},children:t.wrap(y,!0)};t.patch(p,N),h.push(N)}if(h.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:s,properties:{...Ko(c),id:"footnote-label"},children:[{type:"text",value:u}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(h,!0)},{type:"text",value:`
`}]}}const iu=(function(t){if(t==null)return Y3;if(typeof t=="function")return ru(t);if(typeof t=="object")return Array.isArray(t)?I3(t):V3(t);if(typeof t=="string")return G3(t);throw new Error("Expected function, string, or object as test")});function I3(t){const i=[];let a=-1;for(;++a<t.length;)i[a]=iu(t[a]);return ru(r);function r(...u){let s=-1;for(;++s<i.length;)if(i[s].apply(this,u))return!0;return!1}}function V3(t){const i=t;return ru(a);function a(r){const u=r;let s;for(s in t)if(u[s]!==i[s])return!1;return!0}}function G3(t){return ru(i);function i(a){return a&&a.type===t}}function ru(t){return i;function i(a,r,u){return!!(X3(a)&&t.call(this,a,typeof r=="number"?r:void 0,u||void 0))}}function Y3(){return!0}function X3(t){return t!==null&&typeof t=="object"&&"type"in t}const Iy=[],Q3=!0,rf=!1,F3="skip";function Vy(t,i,a,r){let u;typeof i=="function"&&typeof a!="function"?(r=a,a=i):u=i;const s=iu(u),c=r?-1:1;h(t,void 0,[])();function h(m,p,y){const g=m&&typeof m=="object"?m:{};if(typeof g.type=="string"){const S=typeof g.tagName=="string"?g.tagName:typeof g.name=="string"?g.name:void 0;Object.defineProperty(b,"name",{value:"node ("+(m.type+(S?"<"+S+">":""))+")"})}return b;function b(){let S=Iy,E,z,T;if((!i||s(m,p,y[y.length-1]||void 0))&&(S=Z3(a(m,y)),S[0]===rf))return S;if("children"in m&&m.children){const N=m;if(N.children&&S[0]!==F3)for(z=(r?N.children.length:-1)+c,T=y.concat(N);z>-1&&z<N.children.length;){const D=N.children[z];if(E=h(D,z,T)(),E[0]===rf)return E;z=typeof E[1]=="number"?E[1]:z+c}}return S}}}function Z3(t){return Array.isArray(t)?t:typeof t=="number"?[Q3,t]:t==null?Iy:[t]}function Uf(t,i,a,r){let u,s,c;typeof i=="function"&&typeof a!="function"?(s=void 0,c=i,u=a):(s=i,c=a,u=r),Vy(t,s,h,u);function h(m,p){const y=p[p.length-1],g=y?y.children.indexOf(m):void 0;return c(m,g,y)}}const of={}.hasOwnProperty,K3={};function $3(t,i){const a=i||K3,r=new Map,u=new Map,s=new Map,c={...D3,...a.handlers},h={all:p,applyData:J3,definitionById:r,footnoteById:u,footnoteCounts:s,footnoteOrder:[],handlers:c,one:m,options:a,patch:P3,wrap:e4};return Uf(t,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const g=y.type==="definition"?r:u,b=String(y.identifier).toUpperCase();g.has(b)||g.set(b,y)}}),h;function m(y,g){const b=y.type,S=h.handlers[b];if(of.call(h.handlers,b)&&S)return S(h,y,g);if(h.options.passThrough&&h.options.passThrough.includes(b)){if("children"in y){const{children:z,...T}=y,N=Ko(T);return N.children=h.all(y),N}return Ko(y)}return(h.options.unknownHandler||W3)(h,y,g)}function p(y){const g=[];if("children"in y){const b=y.children;let S=-1;for(;++S<b.length;){const E=h.one(b[S],y);if(E){if(S&&b[S-1].type==="break"&&(!Array.isArray(E)&&E.type==="text"&&(E.value=Fg(E.value)),!Array.isArray(E)&&E.type==="element")){const z=E.children[0];z&&z.type==="text"&&(z.value=Fg(z.value))}Array.isArray(E)?g.push(...E):g.push(E)}}}return g}}function P3(t,i){t.position&&(i.position=UA(t))}function J3(t,i){let a=i;if(t&&t.data){const r=t.data.hName,u=t.data.hChildren,s=t.data.hProperties;if(typeof r=="string")if(a.type==="element")a.tagName=r;else{const c="children"in a?a.children:[a];a={type:"element",tagName:r,properties:{},children:c}}a.type==="element"&&s&&Object.assign(a.properties,Ko(s)),"children"in a&&a.children&&u!==null&&u!==void 0&&(a.children=u)}return a}function W3(t,i){const a=i.data||{},r="value"in i&&!(of.call(a,"hProperties")||of.call(a,"hChildren"))?{type:"text",value:i.value}:{type:"element",tagName:"div",properties:{},children:t.all(i)};return t.patch(i,r),t.applyData(i,r)}function e4(t,i){const a=[];let r=-1;for(i&&a.push({type:"text",value:`
`});++r<t.length;)r&&a.push({type:"text",value:`
`}),a.push(t[r]);return i&&t.length>0&&a.push({type:"text",value:`
`}),a}function Fg(t){let i=0,a=t.charCodeAt(i);for(;a===9||a===32;)i++,a=t.charCodeAt(i);return t.slice(i)}function Zg(t,i){const a=$3(t,i),r=a.one(t,void 0),u=q3(a),s=Array.isArray(r)?{type:"root",children:r}:r||{type:"root",children:[]};return u&&s.children.push({type:"text",value:`
`},u),s}function n4(t,i){return t&&"run"in t?async function(a,r){const u=Zg(a,{file:r,...i});await t.run(u,r)}:function(a,r){return Zg(a,{file:r,...t||i})}}function Kg(t){if(t)throw t}var Hc,$g;function t4(){if($g)return Hc;$g=1;var t=Object.prototype.hasOwnProperty,i=Object.prototype.toString,a=Object.defineProperty,r=Object.getOwnPropertyDescriptor,u=function(p){return typeof Array.isArray=="function"?Array.isArray(p):i.call(p)==="[object Array]"},s=function(p){if(!p||i.call(p)!=="[object Object]")return!1;var y=t.call(p,"constructor"),g=p.constructor&&p.constructor.prototype&&t.call(p.constructor.prototype,"isPrototypeOf");if(p.constructor&&!y&&!g)return!1;var b;for(b in p);return typeof b>"u"||t.call(p,b)},c=function(p,y){a&&y.name==="__proto__"?a(p,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):p[y.name]=y.newValue},h=function(p,y){if(y==="__proto__")if(t.call(p,y)){if(r)return r(p,y).value}else return;return p[y]};return Hc=function m(){var p,y,g,b,S,E,z=arguments[0],T=1,N=arguments.length,D=!1;for(typeof z=="boolean"&&(D=z,z=arguments[1]||{},T=2),(z==null||typeof z!="object"&&typeof z!="function")&&(z={});T<N;++T)if(p=arguments[T],p!=null)for(y in p)g=h(z,y),b=h(p,y),z!==b&&(D&&b&&(s(b)||(S=u(b)))?(S?(S=!1,E=g&&u(g)?g:[]):E=g&&s(g)?g:{},c(z,{name:y,newValue:m(D,E,b)})):typeof b<"u"&&c(z,{name:y,newValue:b}));return z},Hc}var l4=t4();const Uc=pf(l4);function uf(t){if(typeof t!="object"||t===null)return!1;const i=Object.getPrototypeOf(t);return(i===null||i===Object.prototype||Object.getPrototypeOf(i)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function a4(){const t=[],i={run:a,use:r};return i;function a(...u){let s=-1;const c=u.pop();if(typeof c!="function")throw new TypeError("Expected function as last argument, not "+c);h(null,...u);function h(m,...p){const y=t[++s];let g=-1;if(m){c(m);return}for(;++g<u.length;)(p[g]===null||p[g]===void 0)&&(p[g]=u[g]);u=p,y?i4(y,h)(...p):c(null,...p)}}function r(u){if(typeof u!="function")throw new TypeError("Expected `middelware` to be a function, not "+u);return t.push(u),i}}function i4(t,i){let a;return r;function r(...c){const h=t.length>c.length;let m;h&&c.push(u);try{m=t.apply(this,c)}catch(p){const y=p;if(h&&a)throw y;return u(y)}h||(m&&m.then&&typeof m.then=="function"?m.then(s,u):m instanceof Error?u(m):s(m))}function u(c,...h){a||(a=!0,i(c,...h))}function s(c){u(null,c)}}const St={basename:r4,dirname:o4,extname:u4,join:s4,sep:"/"};function r4(t,i){if(i!==void 0&&typeof i!="string")throw new TypeError('"ext" argument must be a string');dr(t);let a=0,r=-1,u=t.length,s;if(i===void 0||i.length===0||i.length>t.length){for(;u--;)if(t.codePointAt(u)===47){if(s){a=u+1;break}}else r<0&&(s=!0,r=u+1);return r<0?"":t.slice(a,r)}if(i===t)return"";let c=-1,h=i.length-1;for(;u--;)if(t.codePointAt(u)===47){if(s){a=u+1;break}}else c<0&&(s=!0,c=u+1),h>-1&&(t.codePointAt(u)===i.codePointAt(h--)?h<0&&(r=u):(h=-1,r=c));return a===r?r=c:r<0&&(r=t.length),t.slice(a,r)}function o4(t){if(dr(t),t.length===0)return".";let i=-1,a=t.length,r;for(;--a;)if(t.codePointAt(a)===47){if(r){i=a;break}}else r||(r=!0);return i<0?t.codePointAt(0)===47?"/":".":i===1&&t.codePointAt(0)===47?"//":t.slice(0,i)}function u4(t){dr(t);let i=t.length,a=-1,r=0,u=-1,s=0,c;for(;i--;){const h=t.codePointAt(i);if(h===47){if(c){r=i+1;break}continue}a<0&&(c=!0,a=i+1),h===46?u<0?u=i:s!==1&&(s=1):u>-1&&(s=-1)}return u<0||a<0||s===0||s===1&&u===a-1&&u===r+1?"":t.slice(u,a)}function s4(...t){let i=-1,a;for(;++i<t.length;)dr(t[i]),t[i]&&(a=a===void 0?t[i]:a+"/"+t[i]);return a===void 0?".":c4(a)}function c4(t){dr(t);const i=t.codePointAt(0)===47;let a=f4(t,!i);return a.length===0&&!i&&(a="."),a.length>0&&t.codePointAt(t.length-1)===47&&(a+="/"),i?"/"+a:a}function f4(t,i){let a="",r=0,u=-1,s=0,c=-1,h,m;for(;++c<=t.length;){if(c<t.length)h=t.codePointAt(c);else{if(h===47)break;h=47}if(h===47){if(!(u===c-1||s===1))if(u!==c-1&&s===2){if(a.length<2||r!==2||a.codePointAt(a.length-1)!==46||a.codePointAt(a.length-2)!==46){if(a.length>2){if(m=a.lastIndexOf("/"),m!==a.length-1){m<0?(a="",r=0):(a=a.slice(0,m),r=a.length-1-a.lastIndexOf("/")),u=c,s=0;continue}}else if(a.length>0){a="",r=0,u=c,s=0;continue}}i&&(a=a.length>0?a+"/..":"..",r=2)}else a.length>0?a+="/"+t.slice(u+1,c):a=t.slice(u+1,c),r=c-u-1;u=c,s=0}else h===46&&s>-1?s++:s=-1}return a}function dr(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const d4={cwd:h4};function h4(){return"/"}function sf(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function p4(t){if(typeof t=="string")t=new URL(t);else if(!sf(t)){const i=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw i.code="ERR_INVALID_ARG_TYPE",i}if(t.protocol!=="file:"){const i=new TypeError("The URL must be of scheme file");throw i.code="ERR_INVALID_URL_SCHEME",i}return m4(t)}function m4(t){if(t.hostname!==""){const r=new TypeError('File URL host must be "localhost" or empty on darwin');throw r.code="ERR_INVALID_FILE_URL_HOST",r}const i=t.pathname;let a=-1;for(;++a<i.length;)if(i.codePointAt(a)===37&&i.codePointAt(a+1)===50){const r=i.codePointAt(a+2);if(r===70||r===102){const u=new TypeError("File URL path must not include encoded / characters");throw u.code="ERR_INVALID_FILE_URL_PATH",u}}return decodeURIComponent(i)}const qc=["history","path","basename","stem","extname","dirname"];class Gy{constructor(i){let a;i?sf(i)?a={path:i}:typeof i=="string"||g4(i)?a={value:i}:a=i:a={},this.cwd="cwd"in a?"":d4.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let r=-1;for(;++r<qc.length;){const s=qc[r];s in a&&a[s]!==void 0&&a[s]!==null&&(this[s]=s==="history"?[...a[s]]:a[s])}let u;for(u in a)qc.includes(u)||(this[u]=a[u])}get basename(){return typeof this.path=="string"?St.basename(this.path):void 0}set basename(i){Vc(i,"basename"),Ic(i,"basename"),this.path=St.join(this.dirname||"",i)}get dirname(){return typeof this.path=="string"?St.dirname(this.path):void 0}set dirname(i){Pg(this.basename,"dirname"),this.path=St.join(i||"",this.basename)}get extname(){return typeof this.path=="string"?St.extname(this.path):void 0}set extname(i){if(Ic(i,"extname"),Pg(this.dirname,"extname"),i){if(i.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(i.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=St.join(this.dirname,this.stem+(i||""))}get path(){return this.history[this.history.length-1]}set path(i){sf(i)&&(i=p4(i)),Vc(i,"path"),this.path!==i&&this.history.push(i)}get stem(){return typeof this.path=="string"?St.basename(this.path,this.extname):void 0}set stem(i){Vc(i,"stem"),Ic(i,"stem"),this.path=St.join(this.dirname||"",i+(this.extname||""))}fail(i,a,r){const u=this.message(i,a,r);throw u.fatal=!0,u}info(i,a,r){const u=this.message(i,a,r);return u.fatal=void 0,u}message(i,a,r){const u=new wn(i,a,r);return this.path&&(u.name=this.path+":"+u.name,u.file=this.path),u.fatal=!1,this.messages.push(u),u}toString(i){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(i||void 0).decode(this.value)}}function Ic(t,i){if(t&&t.includes(St.sep))throw new Error("`"+i+"` cannot be a path: did not expect `"+St.sep+"`")}function Vc(t,i){if(!t)throw new Error("`"+i+"` cannot be empty")}function Pg(t,i){if(!t)throw new Error("Setting `"+i+"` requires `path` to be set too")}function g4(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const y4=(function(t){const r=this.constructor.prototype,u=r[t],s=function(){return u.apply(s,arguments)};return Object.setPrototypeOf(s,r),s}),x4={}.hasOwnProperty;class qf extends y4{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=a4()}copy(){const i=new qf;let a=-1;for(;++a<this.attachers.length;){const r=this.attachers[a];i.use(...r)}return i.data(Uc(!0,{},this.namespace)),i}data(i,a){return typeof i=="string"?arguments.length===2?(Xc("data",this.frozen),this.namespace[i]=a,this):x4.call(this.namespace,i)&&this.namespace[i]||void 0:i?(Xc("data",this.frozen),this.namespace=i,this):this.namespace}freeze(){if(this.frozen)return this;const i=this;for(;++this.freezeIndex<this.attachers.length;){const[a,...r]=this.attachers[this.freezeIndex];if(r[0]===!1)continue;r[0]===!0&&(r[0]=void 0);const u=a.call(i,...r);typeof u=="function"&&this.transformers.use(u)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(i){this.freeze();const a=Ho(i),r=this.parser||this.Parser;return Gc("parse",r),r(String(a),a)}process(i,a){const r=this;return this.freeze(),Gc("process",this.parser||this.Parser),Yc("process",this.compiler||this.Compiler),a?u(void 0,a):new Promise(u);function u(s,c){const h=Ho(i),m=r.parse(h);r.run(m,h,function(y,g,b){if(y||!g||!b)return p(y);const S=g,E=r.stringify(S,b);S4(E)?b.value=E:b.result=E,p(y,b)});function p(y,g){y||!g?c(y):s?s(g):a(void 0,g)}}}processSync(i){let a=!1,r;return this.freeze(),Gc("processSync",this.parser||this.Parser),Yc("processSync",this.compiler||this.Compiler),this.process(i,u),Wg("processSync","process",a),r;function u(s,c){a=!0,Kg(s),r=c}}run(i,a,r){Jg(i),this.freeze();const u=this.transformers;return!r&&typeof a=="function"&&(r=a,a=void 0),r?s(void 0,r):new Promise(s);function s(c,h){const m=Ho(a);u.run(i,m,p);function p(y,g,b){const S=g||i;y?h(y):c?c(S):r(void 0,S,b)}}}runSync(i,a){let r=!1,u;return this.run(i,a,s),Wg("runSync","run",r),u;function s(c,h){Kg(c),u=h,r=!0}}stringify(i,a){this.freeze();const r=Ho(a),u=this.compiler||this.Compiler;return Yc("stringify",u),Jg(i),u(i,r)}use(i,...a){const r=this.attachers,u=this.namespace;if(Xc("use",this.frozen),i!=null)if(typeof i=="function")m(i,a);else if(typeof i=="object")Array.isArray(i)?h(i):c(i);else throw new TypeError("Expected usable value, not `"+i+"`");return this;function s(p){if(typeof p=="function")m(p,[]);else if(typeof p=="object")if(Array.isArray(p)){const[y,...g]=p;m(y,g)}else c(p);else throw new TypeError("Expected usable value, not `"+p+"`")}function c(p){if(!("plugins"in p)&&!("settings"in p))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");h(p.plugins),p.settings&&(u.settings=Uc(!0,u.settings,p.settings))}function h(p){let y=-1;if(p!=null)if(Array.isArray(p))for(;++y<p.length;){const g=p[y];s(g)}else throw new TypeError("Expected a list of plugins, not `"+p+"`")}function m(p,y){let g=-1,b=-1;for(;++g<r.length;)if(r[g][0]===p){b=g;break}if(b===-1)r.push([p,...y]);else if(y.length>0){let[S,...E]=y;const z=r[b][1];uf(z)&&uf(S)&&(S=Uc(!0,z,S)),r[b]=[p,S,...E]}}}}const b4=new qf().freeze();function Gc(t,i){if(typeof i!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Yc(t,i){if(typeof i!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Xc(t,i){if(i)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function Jg(t){if(!uf(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function Wg(t,i,a){if(!a)throw new Error("`"+t+"` finished async. Use `"+i+"` instead")}function Ho(t){return v4(t)?t:new Gy(t)}function v4(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function S4(t){return typeof t=="string"||w4(t)}function w4(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const A4="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",e1=[],n1={allowDangerousHtml:!0},k4=/^(https?|ircs?|mailto|xmpp)$/i,E4=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function C4(t){const i=T4(t),a=N4(t);return _4(i.runSync(i.parse(a),a),t)}function T4(t){const i=t.rehypePlugins||e1,a=t.remarkPlugins||e1,r=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...n1}:n1;return b4().use(o3).use(a).use(n4,r).use(i)}function N4(t){const i=t.children||"",a=new Gy;return typeof i=="string"&&(a.value=i),a}function _4(t,i){const a=i.allowedElements,r=i.allowElement,u=i.components,s=i.disallowedElements,c=i.skipHtml,h=i.unwrapDisallowed,m=i.urlTransform||z4;for(const y of E4)Object.hasOwn(i,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+A4+y.id,void 0);return Uf(t,p),YA(t,{Fragment:v.Fragment,components:u,ignoreInvalidStyle:!0,jsx:v.jsx,jsxs:v.jsxs,passKeys:!0,passNode:!0});function p(y,g,b){if(y.type==="raw"&&b&&typeof g=="number")return c?b.children.splice(g,1):b.children[g]={type:"text",value:y.value},g;if(y.type==="element"){let S;for(S in Oc)if(Object.hasOwn(Oc,S)&&Object.hasOwn(y.properties,S)){const E=y.properties[S],z=Oc[S];(z===null||z.includes(y.tagName))&&(y.properties[S]=m(String(E||""),S,y))}}if(y.type==="element"){let S=a?!a.includes(y.tagName):s?s.includes(y.tagName):!1;if(!S&&r&&typeof g=="number"&&(S=!r(y,g,b)),S&&b&&typeof g=="number")return h&&y.children?b.children.splice(g,1,...y.children):b.children.splice(g,1),g}}}function z4(t){const i=t.indexOf(":"),a=t.indexOf("?"),r=t.indexOf("#"),u=t.indexOf("/");return i===-1||u!==-1&&i>u||a!==-1&&i>a||r!==-1&&i>r||k4.test(t.slice(0,i))?t:""}function t1(t,i){const a=String(t);if(typeof i!="string")throw new TypeError("Expected character");let r=0,u=a.indexOf(i);for(;u!==-1;)r++,u=a.indexOf(i,u+i.length);return r}function R4(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function M4(t,i,a){const u=iu((a||{}).ignore||[]),s=D4(i);let c=-1;for(;++c<s.length;)Vy(t,"text",h);function h(p,y){let g=-1,b;for(;++g<y.length;){const S=y[g],E=b?b.children:void 0;if(u(S,E?E.indexOf(S):void 0,b))return;b=S}if(b)return m(p,y)}function m(p,y){const g=y[y.length-1],b=s[c][0],S=s[c][1];let E=0;const T=g.children.indexOf(p);let N=!1,D=[];b.lastIndex=0;let j=b.exec(p.value);for(;j;){const Z=j.index,W={index:j.index,input:j.input,stack:[...y,p]};let q=S(...j,W);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?b.lastIndex=Z+1:(E!==Z&&D.push({type:"text",value:p.value.slice(E,Z)}),Array.isArray(q)?D.push(...q):q&&D.push(q),E=Z+j[0].length,N=!0),!b.global)break;j=b.exec(p.value)}return N?(E<p.value.length&&D.push({type:"text",value:p.value.slice(E)}),g.children.splice(T,1,...D)):D=[p],T+D.length}}function D4(t){const i=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const a=!t[0]||Array.isArray(t[0])?t:[t];let r=-1;for(;++r<a.length;){const u=a[r];i.push([j4(u[0]),O4(u[1])])}return i}function j4(t){return typeof t=="string"?new RegExp(R4(t),"g"):t}function O4(t){return typeof t=="function"?t:function(){return t}}const Qc="phrasing",Fc=["autolink","link","image","label"];function L4(){return{transforms:[G4],enter:{literalAutolink:H4,literalAutolinkEmail:Zc,literalAutolinkHttp:Zc,literalAutolinkWww:Zc},exit:{literalAutolink:V4,literalAutolinkEmail:I4,literalAutolinkHttp:U4,literalAutolinkWww:q4}}}function B4(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Qc,notInConstruct:Fc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Qc,notInConstruct:Fc},{character:":",before:"[ps]",after:"\\/",inConstruct:Qc,notInConstruct:Fc}]}}function H4(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Zc(t){this.config.enter.autolinkProtocol.call(this,t)}function U4(t){this.config.exit.autolinkProtocol.call(this,t)}function q4(t){this.config.exit.data.call(this,t);const i=this.stack[this.stack.length-1];i.type,i.url="http://"+this.sliceSerialize(t)}function I4(t){this.config.exit.autolinkEmail.call(this,t)}function V4(t){this.exit(t)}function G4(t){M4(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,Y4],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),X4]],{ignore:["link","linkReference"]})}function Y4(t,i,a,r,u){let s="";if(!Yy(u)||(/^w/i.test(i)&&(a=i+a,i="",s="http://"),!Q4(a)))return!1;const c=F4(a+r);if(!c[0])return!1;const h={type:"link",title:null,url:s+i+c[0],children:[{type:"text",value:i+c[0]}]};return c[1]?[h,{type:"text",value:c[1]}]:h}function X4(t,i,a,r){return!Yy(r,!0)||/[-\d_]$/.test(a)?!1:{type:"link",title:null,url:"mailto:"+i+"@"+a,children:[{type:"text",value:i+"@"+a}]}}function Q4(t){const i=t.split(".");return!(i.length<2||i[i.length-1]&&(/_/.test(i[i.length-1])||!/[a-zA-Z\d]/.test(i[i.length-1]))||i[i.length-2]&&(/_/.test(i[i.length-2])||!/[a-zA-Z\d]/.test(i[i.length-2])))}function F4(t){const i=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!i)return[t,void 0];t=t.slice(0,i.index);let a=i[0],r=a.indexOf(")");const u=t1(t,"(");let s=t1(t,")");for(;r!==-1&&u>s;)t+=a.slice(0,r+1),a=a.slice(r+1),r=a.indexOf(")"),s++;return[t,a]}function Yy(t,i){const a=t.input.charCodeAt(t.index-1);return(t.index===0||$l(a)||tu(a))&&(!i||a!==47)}Xy.peek=tC;function Z4(){this.buffer()}function K4(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function $4(){this.buffer()}function P4(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function J4(t){const i=this.resume(),a=this.stack[this.stack.length-1];a.type,a.identifier=pt(this.sliceSerialize(t)).toLowerCase(),a.label=i}function W4(t){this.exit(t)}function eC(t){const i=this.resume(),a=this.stack[this.stack.length-1];a.type,a.identifier=pt(this.sliceSerialize(t)).toLowerCase(),a.label=i}function nC(t){this.exit(t)}function tC(){return"["}function Xy(t,i,a,r){const u=a.createTracker(r);let s=u.move("[^");const c=a.enter("footnoteReference"),h=a.enter("reference");return s+=u.move(a.safe(a.associationId(t),{after:"]",before:s})),h(),c(),s+=u.move("]"),s}function lC(){return{enter:{gfmFootnoteCallString:Z4,gfmFootnoteCall:K4,gfmFootnoteDefinitionLabelString:$4,gfmFootnoteDefinition:P4},exit:{gfmFootnoteCallString:J4,gfmFootnoteCall:W4,gfmFootnoteDefinitionLabelString:eC,gfmFootnoteDefinition:nC}}}function aC(t){let i=!1;return t&&t.firstLineBlank&&(i=!0),{handlers:{footnoteDefinition:a,footnoteReference:Xy},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function a(r,u,s,c){const h=s.createTracker(c);let m=h.move("[^");const p=s.enter("footnoteDefinition"),y=s.enter("label");return m+=h.move(s.safe(s.associationId(r),{before:m,after:"]"})),y(),m+=h.move("]:"),r.children&&r.children.length>0&&(h.shift(4),m+=h.move((i?`
`:" ")+s.indentLines(s.containerFlow(r,h.current()),i?Qy:iC))),p(),m}}function iC(t,i,a){return i===0?t:Qy(t,i,a)}function Qy(t,i,a){return(a?"":"    ")+t}const rC=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];Fy.peek=fC;function oC(){return{canContainEols:["delete"],enter:{strikethrough:sC},exit:{strikethrough:cC}}}function uC(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:rC}],handlers:{delete:Fy}}}function sC(t){this.enter({type:"delete",children:[]},t)}function cC(t){this.exit(t)}function Fy(t,i,a,r){const u=a.createTracker(r),s=a.enter("strikethrough");let c=u.move("~~");return c+=a.containerPhrasing(t,{...u.current(),before:c,after:"~"}),c+=u.move("~~"),s(),c}function fC(){return"~"}function dC(t){return t.length}function hC(t,i){const a=i||{},r=(a.align||[]).concat(),u=a.stringLength||dC,s=[],c=[],h=[],m=[];let p=0,y=-1;for(;++y<t.length;){const z=[],T=[];let N=-1;for(t[y].length>p&&(p=t[y].length);++N<t[y].length;){const D=pC(t[y][N]);if(a.alignDelimiters!==!1){const j=u(D);T[N]=j,(m[N]===void 0||j>m[N])&&(m[N]=j)}z.push(D)}c[y]=z,h[y]=T}let g=-1;if(typeof r=="object"&&"length"in r)for(;++g<p;)s[g]=l1(r[g]);else{const z=l1(r);for(;++g<p;)s[g]=z}g=-1;const b=[],S=[];for(;++g<p;){const z=s[g];let T="",N="";z===99?(T=":",N=":"):z===108?T=":":z===114&&(N=":");let D=a.alignDelimiters===!1?1:Math.max(1,m[g]-T.length-N.length);const j=T+"-".repeat(D)+N;a.alignDelimiters!==!1&&(D=T.length+D+N.length,D>m[g]&&(m[g]=D),S[g]=D),b[g]=j}c.splice(1,0,b),h.splice(1,0,S),y=-1;const E=[];for(;++y<c.length;){const z=c[y],T=h[y];g=-1;const N=[];for(;++g<p;){const D=z[g]||"";let j="",Z="";if(a.alignDelimiters!==!1){const W=m[g]-(T[g]||0),q=s[g];q===114?j=" ".repeat(W):q===99?W%2?(j=" ".repeat(W/2+.5),Z=" ".repeat(W/2-.5)):(j=" ".repeat(W/2),Z=j):Z=" ".repeat(W)}a.delimiterStart!==!1&&!g&&N.push("|"),a.padding!==!1&&!(a.alignDelimiters===!1&&D==="")&&(a.delimiterStart!==!1||g)&&N.push(" "),a.alignDelimiters!==!1&&N.push(j),N.push(D),a.alignDelimiters!==!1&&N.push(Z),a.padding!==!1&&N.push(" "),(a.delimiterEnd!==!1||g!==p-1)&&N.push("|")}E.push(a.delimiterEnd===!1?N.join("").replace(/ +$/,""):N.join(""))}return E.join(`
`)}function pC(t){return t==null?"":String(t)}function l1(t){const i=typeof t=="string"?t.codePointAt(0):0;return i===67||i===99?99:i===76||i===108?108:i===82||i===114?114:0}function mC(t,i,a,r){const u=a.enter("blockquote"),s=a.createTracker(r);s.move("> "),s.shift(2);const c=a.indentLines(a.containerFlow(t,s.current()),gC);return u(),c}function gC(t,i,a){return">"+(a?"":" ")+t}function yC(t,i){return a1(t,i.inConstruct,!0)&&!a1(t,i.notInConstruct,!1)}function a1(t,i,a){if(typeof i=="string"&&(i=[i]),!i||i.length===0)return a;let r=-1;for(;++r<i.length;)if(t.includes(i[r]))return!0;return!1}function i1(t,i,a,r){let u=-1;for(;++u<a.unsafe.length;)if(a.unsafe[u].character===`
`&&yC(a.stack,a.unsafe[u]))return/[ \t]/.test(r.before)?"":" ";return`\\
`}function xC(t,i){const a=String(t);let r=a.indexOf(i),u=r,s=0,c=0;if(typeof i!="string")throw new TypeError("Expected substring");for(;r!==-1;)r===u?++s>c&&(c=s):s=1,u=r+i.length,r=a.indexOf(i,u);return c}function bC(t,i){return!!(i.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function vC(t){const i=t.options.fence||"`";if(i!=="`"&&i!=="~")throw new Error("Cannot serialize code with `"+i+"` for `options.fence`, expected `` ` `` or `~`");return i}function SC(t,i,a,r){const u=vC(a),s=t.value||"",c=u==="`"?"GraveAccent":"Tilde";if(bC(t,a)){const g=a.enter("codeIndented"),b=a.indentLines(s,wC);return g(),b}const h=a.createTracker(r),m=u.repeat(Math.max(xC(s,u)+1,3)),p=a.enter("codeFenced");let y=h.move(m);if(t.lang){const g=a.enter(`codeFencedLang${c}`);y+=h.move(a.safe(t.lang,{before:y,after:" ",encode:["`"],...h.current()})),g()}if(t.lang&&t.meta){const g=a.enter(`codeFencedMeta${c}`);y+=h.move(" "),y+=h.move(a.safe(t.meta,{before:y,after:`
`,encode:["`"],...h.current()})),g()}return y+=h.move(`
`),s&&(y+=h.move(s+`
`)),y+=h.move(m),p(),y}function wC(t,i,a){return(a?"":"    ")+t}function If(t){const i=t.options.quote||'"';if(i!=='"'&&i!=="'")throw new Error("Cannot serialize title with `"+i+"` for `options.quote`, expected `\"`, or `'`");return i}function AC(t,i,a,r){const u=If(a),s=u==='"'?"Quote":"Apostrophe",c=a.enter("definition");let h=a.enter("label");const m=a.createTracker(r);let p=m.move("[");return p+=m.move(a.safe(a.associationId(t),{before:p,after:"]",...m.current()})),p+=m.move("]: "),h(),!t.url||/[\0- \u007F]/.test(t.url)?(h=a.enter("destinationLiteral"),p+=m.move("<"),p+=m.move(a.safe(t.url,{before:p,after:">",...m.current()})),p+=m.move(">")):(h=a.enter("destinationRaw"),p+=m.move(a.safe(t.url,{before:p,after:t.title?" ":`
`,...m.current()}))),h(),t.title&&(h=a.enter(`title${s}`),p+=m.move(" "+u),p+=m.move(a.safe(t.title,{before:p,after:u,...m.current()})),p+=m.move(u),h()),c(),p}function kC(t){const i=t.options.emphasis||"*";if(i!=="*"&&i!=="_")throw new Error("Cannot serialize emphasis with `"+i+"` for `options.emphasis`, expected `*`, or `_`");return i}function rr(t){return"&#x"+t.toString(16).toUpperCase()+";"}function $o(t,i,a){const r=Za(t),u=Za(i);return r===void 0?u===void 0?a==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:u===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:r===1?u===void 0?{inside:!1,outside:!1}:u===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:u===void 0?{inside:!1,outside:!1}:u===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Zy.peek=EC;function Zy(t,i,a,r){const u=kC(a),s=a.enter("emphasis"),c=a.createTracker(r),h=c.move(u);let m=c.move(a.containerPhrasing(t,{after:u,before:h,...c.current()}));const p=m.charCodeAt(0),y=$o(r.before.charCodeAt(r.before.length-1),p,u);y.inside&&(m=rr(p)+m.slice(1));const g=m.charCodeAt(m.length-1),b=$o(r.after.charCodeAt(0),g,u);b.inside&&(m=m.slice(0,-1)+rr(g));const S=c.move(u);return s(),a.attentionEncodeSurroundingInfo={after:b.outside,before:y.outside},h+m+S}function EC(t,i,a){return a.options.emphasis||"*"}function CC(t,i){let a=!1;return Uf(t,function(r){if("value"in r&&/\r?\n|\r/.test(r.value)||r.type==="break")return a=!0,rf}),!!((!t.depth||t.depth<3)&&Mf(t)&&(i.options.setext||a))}function TC(t,i,a,r){const u=Math.max(Math.min(6,t.depth||1),1),s=a.createTracker(r);if(CC(t,a)){const y=a.enter("headingSetext"),g=a.enter("phrasing"),b=a.containerPhrasing(t,{...s.current(),before:`
`,after:`
`});return g(),y(),b+`
...
`,...s.current()});return/^[\t ]/.test(p)&&(p=rr(p.charCodeAt(0))+p.slice(1)),p=p?c+" "+p:c,a.options.closeAtx&&(p+=" "+c),m(),h(),p}Ky.peek=NC;function Ky(t){return t.value||""}function NC(){return"<"}$y.peek=_C;function $y(t,i,a,r){const u=If(a),s=u==='"'?"Quote":"Apostrophe",c=a.enter("image");let h=a.enter("label");const m=a.createTracker(r);let p=m.move("![");return p+=m.move(a.safe(t.alt,{before:p,after:"]",...m.current()})),p+=m.move("]("),h(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(h=a.enter("destinationLiteral"),p+=m.move("<"),p+=m.move(a.safe(t.url,{before:p,after:">",...m.current()})),p+=m.move(">")):(h=a.enter("destinationRaw"),p+=m.move(a.safe(t.url,{before:p,after:t.title?" ":")",...m.current()}))),h(),t.title&&(h=a.enter(`title${s}`),p+=m.move(" "+u),p+=m.move(a.safe(t.title,{before:p,after:u,...m.current()})),p+=m.move(u),h()),p+=m.move(")"),c(),p}function _C(){return"!"}Py.peek=zC;function Py(t,i,a,r){const u=t.referenceType,s=a.enter("imageReference");let c=a.enter("label");const h=a.createTracker(r);let m=h.move("![");const p=a.safe(t.alt,{before:m,after:"]",...h.current()});m+=h.move(p+"]["),c();const y=a.stack;a.stack=[],c=a.enter("reference");const g=a.safe(a.associationId(t),{before:m,after:"]",...h.current()});return c(),a.stack=y,s(),u==="full"||!p||p!==g?m+=h.move(g+"]"):u==="shortcut"?m=m.slice(0,-1):m+=h.move("]"),m}function zC(){return"!"}Jy.peek=RC;function Jy(t,i,a){let r=t.value||"",u="`",s=-1;for(;new RegExp("(^|[^`])"+u+"([^`]|$)").test(r);)u+="`";for(/[^ \r\n]/.test(r)&&(/^[ \r\n]/.test(r)&&/[ \r\n]$/.test(r)||/^`|`$/.test(r))&&(r=" "+r+" ");++s<a.unsafe.length;){const c=a.unsafe[s],h=a.compilePattern(c);let m;if(c.atBreak)for(;m=h.exec(r);){let p=m.index;r.charCodeAt(p)===10&&r.charCodeAt(p-1)===13&&p--,r=r.slice(0,p)+" "+r.slice(m.index+1)}}return u+r+u}function RC(){return"`"}function Wy(t,i){const a=Mf(t);return!!(!i.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(a===t.url||"mailto:"+a===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}ex.peek=MC;function ex(t,i,a,r){const u=If(a),s=u==='"'?"Quote":"Apostrophe",c=a.createTracker(r);let h,m;if(Wy(t,a)){const y=a.stack;a.stack=[],h=a.enter("autolink");let g=c.move("<");return g+=c.move(a.containerPhrasing(t,{before:g,after:">",...c.current()})),g+=c.move(">"),h(),a.stack=y,g}h=a.enter("link"),m=a.enter("label");let p=c.move("[");return p+=c.move(a.containerPhrasing(t,{before:p,after:"](",...c.current()})),p+=c.move("]("),m(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(m=a.enter("destinationLiteral"),p+=c.move("<"),p+=c.move(a.safe(t.url,{before:p,after:">",...c.current()})),p+=c.move(">")):(m=a.enter("destinationRaw"),p+=c.move(a.safe(t.url,{before:p,after:t.title?" ":")",...c.current()}))),m(),t.title&&(m=a.enter(`title${s}`),p+=c.move(" "+u),p+=c.move(a.safe(t.title,{before:p,after:u,...c.current()})),p+=c.move(u),m()),p+=c.move(")"),h(),p}function MC(t,i,a){return Wy(t,a)?"<":"["}nx.peek=DC;function nx(t,i,a,r){const u=t.referenceType,s=a.enter("linkReference");let c=a.enter("label");const h=a.createTracker(r);let m=h.move("[");const p=a.containerPhrasing(t,{before:m,after:"]",...h.current()});m+=h.move(p+"]["),c();const y=a.stack;a.stack=[],c=a.enter("reference");const g=a.safe(a.associationId(t),{before:m,after:"]",...h.current()});return c(),a.stack=y,s(),u==="full"||!p||p!==g?m+=h.move(g+"]"):u==="shortcut"?m=m.slice(0,-1):m+=h.move("]"),m}function DC(){return"["}function Vf(t){const i=t.options.bullet||"*";if(i!=="*"&&i!=="+"&&i!=="-")throw new Error("Cannot serialize items with `"+i+"` for `options.bullet`, expected `*`, `+`, or `-`");return i}function jC(t){const i=Vf(t),a=t.options.bulletOther;if(!a)return i==="*"?"-":"*";if(a!=="*"&&a!=="+"&&a!=="-")throw new Error("Cannot serialize items with `"+a+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(a===i)throw new Error("Expected `bullet` (`"+i+"`) and `bulletOther` (`"+a+"`) to be different");return a}function OC(t){const i=t.options.bulletOrdered||".";if(i!=="."&&i!==")")throw new Error("Cannot serialize items with `"+i+"` for `options.bulletOrdered`, expected `.` or `)`");return i}function tx(t){const i=t.options.rule||"*";if(i!=="*"&&i!=="-"&&i!=="_")throw new Error("Cannot serialize rules with `"+i+"` for `options.rule`, expected `*`, `-`, or `_`");return i}function LC(t,i,a,r){const u=a.enter("list"),s=a.bulletCurrent;let c=t.ordered?OC(a):Vf(a);const h=t.ordered?c==="."?")":".":jC(a);let m=i&&a.bulletLastUsed?c===a.bulletLastUsed:!1;if(!t.ordered){const y=t.children?t.children[0]:void 0;if((c==="*"||c==="-")&&y&&(!y.children||!y.children[0])&&a.stack[a.stack.length-1]==="list"&&a.stack[a.stack.length-2]==="listItem"&&a.stack[a.stack.length-3]==="list"&&a.stack[a.stack.length-4]==="listItem"&&a.indexStack[a.indexStack.length-1]===0&&a.indexStack[a.indexStack.length-2]===0&&a.indexStack[a.indexStack.length-3]===0&&(m=!0),tx(a)===c&&y){let g=-1;for(;++g<t.children.length;){const b=t.children[g];if(b&&b.type==="listItem"&&b.children&&b.children[0]&&b.children[0].type==="thematicBreak"){m=!0;break}}}}m&&(c=h),a.bulletCurrent=c;const p=a.containerFlow(t,r);return a.bulletLastUsed=c,a.bulletCurrent=s,u(),p}function BC(t){const i=t.options.listItemIndent||"one";if(i!=="tab"&&i!=="one"&&i!=="mixed")throw new Error("Cannot serialize items with `"+i+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return i}function HC(t,i,a,r){const u=BC(a);let s=a.bulletCurrent||Vf(a);i&&i.type==="list"&&i.ordered&&(s=(typeof i.start=="number"&&i.start>-1?i.start:1)+(a.options.incrementListMarker===!1?0:i.children.indexOf(t))+s);let c=s.length+1;(u==="tab"||u==="mixed"&&(i&&i.type==="list"&&i.spread||t.spread))&&(c=Math.ceil(c/4)*4);const h=a.createTracker(r);h.move(s+" ".repeat(c-s.length)),h.shift(c);const m=a.enter("listItem"),p=a.indentLines(a.containerFlow(t,h.current()),y);return m(),p;function y(g,b,S){return b?(S?"":" ".repeat(c))+g:(S?s:s+" ".repeat(c-s.length))+g}}function UC(t,i,a,r){const u=a.enter("paragraph"),s=a.enter("phrasing"),c=a.containerPhrasing(t,r);return s(),u(),c}const qC=iu(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function IC(t,i,a,r){return(t.children.some(function(c){return qC(c)})?a.containerPhrasing:a.containerFlow).call(a,t,r)}function VC(t){const i=t.options.strong||"*";if(i!=="*"&&i!=="_")throw new Error("Cannot serialize strong with `"+i+"` for `options.strong`, expected `*`, or `_`");return i}lx.peek=GC;function lx(t,i,a,r){const u=VC(a),s=a.enter("strong"),c=a.createTracker(r),h=c.move(u+u);let m=c.move(a.containerPhrasing(t,{after:u,before:h,...c.current()}));const p=m.charCodeAt(0),y=$o(r.before.charCodeAt(r.before.length-1),p,u);y.inside&&(m=rr(p)+m.slice(1));const g=m.charCodeAt(m.length-1),b=$o(r.after.charCodeAt(0),g,u);b.inside&&(m=m.slice(0,-1)+rr(g));const S=c.move(u+u);return s(),a.attentionEncodeSurroundingInfo={after:b.outside,before:y.outside},h+m+S}function GC(t,i,a){return a.options.strong||"*"}function YC(t,i,a,r){return a.safe(t.value,r)}function XC(t){const i=t.options.ruleRepetition||3;if(i<3)throw new Error("Cannot serialize rules with repetition `"+i+"` for `options.ruleRepetition`, expected `3` or more");return i}function QC(t,i,a){const r=(tx(a)+(a.options.ruleSpaces?" ":"")).repeat(XC(a));return a.options.ruleSpaces?r.slice(0,-1):r}const ax={blockquote:mC,break:i1,code:SC,definition:AC,emphasis:Zy,hardBreak:i1,heading:TC,html:Ky,image:$y,imageReference:Py,inlineCode:Jy,link:ex,linkReference:nx,list:LC,listItem:HC,paragraph:UC,root:IC,strong:lx,text:YC,thematicBreak:QC};function FC(){return{enter:{table:ZC,tableData:r1,tableHeader:r1,tableRow:$C},exit:{codeText:PC,table:KC,tableData:Kc,tableHeader:Kc,tableRow:Kc}}}function ZC(t){const i=t._align;this.enter({type:"table",align:i.map(function(a){return a==="none"?null:a}),children:[]},t),this.data.inTable=!0}function KC(t){this.exit(t),this.data.inTable=void 0}function $C(t){this.enter({type:"tableRow",children:[]},t)}function Kc(t){this.exit(t)}function r1(t){this.enter({type:"tableCell",children:[]},t)}function PC(t){let i=this.resume();this.data.inTable&&(i=i.replace(/\\([\\|])/g,JC));const a=this.stack[this.stack.length-1];a.type,a.value=i,this.exit(t)}function JC(t,i){return i==="|"?i:t}function WC(t){const i=t||{},a=i.tableCellPadding,r=i.tablePipeAlign,u=i.stringLength,s=a?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
