...
**第四行最值得记**。它不是编的——那些内容真的在你库里，只是你没想到它会去读。

四条里出现任何一条，先别换模型，**先去看轨迹**。
...
**\`02\` 和 \`03\` 分开是关键的一刀**。原始资料要留、要可追溯，但它不是答案；对外回答只用 \`03\`。上一节症状表第四行那个「掺进不相干内容」，多半就是 \`02\` 和 \`04\` 里的东西被读进了回答——而你在平铺的根目录上，连把它们分开的地方都没有。
...
`,...m.current()}))),h(),t.title&&(h=a.enter(`title${u}`),p+=m.move(" "+s),p+=m.move(a.safe(t.title,{before:p,after:s,...m.current()})),p+=m.move(s),h()),c(),p}function _6(t){const i=t.options.emphasis||"*";if(i!=="*"&&i!=="_")throw new Error("Cannot serialize emphasis with `"+i+"` for `options.emphasis`, expected `*`, or `_`");return i}function rr(t){return"&#x"+t.toString(16).toUpperCase()+";"}function $o(t,i,a){const r=Za(t),s=Za(i);return r===void 0?s===void 0?a==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:r===1?s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Z0.peek=N6;function Z0(t,i,a,r){const s=_6(a),u=a.enter("emphasis"),c=a.createTracker(r),h=c.move(s);let m=c.move(a.containerPhrasing(t,{after:s,before:h,...c.current()}));const p=m.charCodeAt(0),y=$o(r.before.charCodeAt(r.before.length-1),p,s);y.inside&&(m=rr(p)+m.slice(1));const g=m.charCodeAt(m.length-1),b=$o(r.after.charCodeAt(0),g,s);b.inside&&(m=m.slice(0,-1)+rr(g));const S=c.move(s);return u(),a.attentionEncodeSurroundingInfo={after:b.outside,before:y.outside},h+m+S}function N6(t,i,a){return a.options.emphasis||"*"}function z6(t,i){let a=!1;return Uf(t,function(r){if("value"in r&&/\r?\n|\r/.test(r.value)||r.type==="break")return a=!0,rf}),!!((!t.depth||t.depth<3)&&Mf(t)&&(i.options.setext||a))}function R6(t,i,a,r){const s=Math.max(Math.min(6,t.depth||1),1),u=a.createTracker(r);if(z6(t,a)){const y=a.enter("headingSetext"),g=a.enter("phrasing"),b=a.containerPhrasing(t,{...u.current(),before:`
`,after:`
`});return g(),y(),b+`
